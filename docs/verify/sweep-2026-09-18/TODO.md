...
8. **CBMC TIMEOUT resume (JOBS=2).** Live file 9,750 rows, 6,292 PROVED, hole ~1,118. Unread new-FAILED is **0**. Current TIMEOUTs (`adm6996fc_readphy`; live `adm6996fc_readreg`) are unmodelled MMIO/softc. Settled 55, still 2 defects. Pid 887 `--resume` only. Do **not** pass `--retry-status`.
