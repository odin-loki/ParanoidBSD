...
Live file while this is written: **9,761** rows, **6,292 PROVED**
(BOUNDED 180 / FAILED 2,593 / ERROR 180 / TIMEOUT 516). ~1,107 pairs
still missing. Unread new-FAILED is 0. Current TIMEOUTs
(`smi_write`; live `rtl_readreg`) are unmodelled MMIO/softc.
