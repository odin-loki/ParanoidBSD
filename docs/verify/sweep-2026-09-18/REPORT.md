...
Live file while this is written: **9,798** rows, **6,292 PROVED**
(BOUNDED 181 / FAILED 2,595 / ERROR 180 / TIMEOUT 550). ~1,070 pairs
...
static table). Current TIMEOUTs (`hptnr hpt_shutdown_vbus`; live
`hptrr hpt_shutdown_vbus`).
