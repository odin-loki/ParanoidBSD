...
Live file while this is written: **9,783** rows, **6,292 PROVED**
(BOUNDED 180 / FAILED 2,595 / ERROR 180 / TIMEOUT 536). ~1,085 pairs
...
static table). Current TIMEOUTs (`gpio_pin_set_active`; live `gpiobus_pin_set`) are unmodelled
MMIO/softc.
