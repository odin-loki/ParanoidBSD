...
Live file while this is written: **9,741** rows, **6,292 PROVED**
(BOUNDED 180 / FAILED 2,593 / ERROR 180 / TIMEOUT 496). ~1,127 pairs
still missing. Unread new-FAILED is 0. Current TIMEOUTs
(`e6060sw_set_vtu`/`readphy`) are unmodelled MMIO/softc. Settled unwind-32
FAILED is 55 (2 defects). Restart remains `--resume` only at JOBS=2
(pid 887). Records:
