...
Live file while this is written: **9,785** rows, **6,292 PROVED**
(BOUNDED 180 / FAILED 2,595 / ERROR 180 / TIMEOUT 538). ~1,083 pairs
...
static table). Current TIMEOUTs (`gpiobus_pin_set`; live `hpt_do_tasks`) are unmodelled
MMIO/softc.
