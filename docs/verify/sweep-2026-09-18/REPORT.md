...
Live file while this is written: **9,742** rows, **6,292 PROVED**
(BOUNDED 180 / FAILED 2,593 / ERROR 180 / TIMEOUT 497). ~1,126 pairs
still missing. Unread new-FAILED is 0. Current TIMEOUTs
(`e6060sw_writephy`; live `readreg`/`writereg`) are unmodelled MMIO/softc.
