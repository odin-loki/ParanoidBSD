...
Live file while this is written: **9,790** rows, **6,292 PROVED**
(BOUNDED 181 / FAILED 2,595 / ERROR 180 / TIMEOUT 542). ~1,078 pairs
...
static table). Current TIMEOUTs (live `fDeSetTCQ`); last BOUNDED was
`GetStamp`.
