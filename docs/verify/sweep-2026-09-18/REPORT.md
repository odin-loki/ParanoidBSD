...
Live file while this is written: **9,769** rows, **6,292 PROVED**
(BOUNDED 180 / FAILED 2,594 / ERROR 180 / TIMEOUT 523). ~1,099 pairs
...
TIMEOUTs (`ukswitch_writephy`; live `ffec_miibus_readreg`) are unmodelled
MMIO/softc.
