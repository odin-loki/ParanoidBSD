...
Live file while this is written: **9,792** rows, **6,292 PROVED**
(BOUNDED 181 / FAILED 2,595 / ERROR 180 / TIMEOUT 544). ~1,076 pairs
...
static table). Current TIMEOUTs (`fDeSetTCQ`; live `fDeSetWriteCache`).
