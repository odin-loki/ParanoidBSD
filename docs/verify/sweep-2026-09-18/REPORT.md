...
Live file while this is written: **9,788** rows, **6,292 PROVED**
(BOUNDED 181 / FAILED 2,595 / ERROR 180 / TIMEOUT 540). ~1,080 pairs
...
static table). Current last is BOUNDED `GetStamp`; TIMEOUTs still filling
(`hpt_do_tasks`).
