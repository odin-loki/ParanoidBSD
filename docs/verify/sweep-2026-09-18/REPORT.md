...
Live file while this is written: **9,775** rows, **6,292 PROVED**
(BOUNDED 180 / FAILED 2,594 / ERROR 180 / TIMEOUT 529). ~1,093 pairs
...
TIMEOUTs (`scmi_msg_get`; live `fxp_miibus_writereg`) are unmodelled
MMIO/softc.
