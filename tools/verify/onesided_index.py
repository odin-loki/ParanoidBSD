...
ONESIDED reports 226 -- down from 1,109 over five rounds of tightening
...
a gate demanding 226 readings before the next commit is a gate somebody
turns off.
...
def main() -> int:
    ...
    # one read and on the record above. ONESIDED reports 226 -- after
    ...
    # gate that demands 226 readings before the next commit is a gate
    # somebody turns off.
    #
