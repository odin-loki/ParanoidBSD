...
export module pbsd.net.cc_dctcp;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/cc/cc_dctcp.c — Cc Dctcp scaffold.
export namespace pbsd::net::cc_dctcp {
