...
export module pbsd.net.nhop_utils;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/route/nhop_utils.c — Nhop Utils scaffold.
export namespace pbsd::net::nhop_utils {
