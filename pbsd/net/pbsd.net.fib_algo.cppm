...
export module pbsd.net.fib_algo;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/route/fib_algo.c — Fib Algo scaffold.
export namespace pbsd::net::fib_algo {
