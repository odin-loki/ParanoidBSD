...
export module pbsd.net.in_fib_algo;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/in_fib_algo.c — In Fib Algo scaffold.
export namespace pbsd::net::in_fib_algo {
...
} // namespace pbsd::net::in_fib_algo
