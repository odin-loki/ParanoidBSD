...
export module pbsd.net.tcp_log_buf;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/tcp_log_buf.c — Tcp Log Buf scaffold.
export namespace pbsd::net::tcp_log_buf {
...
} // namespace pbsd::net::tcp_log_buf
