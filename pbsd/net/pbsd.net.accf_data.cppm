...
export module pbsd.net.accf_data;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/accf_data/accf_data.c — Accf Data scaffold.
export namespace pbsd::net::accf_data {
