...
export module pbsd.net.ip6_forward;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet6/ip6_forward.c — Ip6 Forward scaffold.
export namespace pbsd::net::ip6_forward {
...
} // namespace pbsd::net::ip6_forward
