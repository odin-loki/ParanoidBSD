...
export module pbsd.net.bpf_jitter;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/bpf_jitter.c — Bpf Jitter scaffold.
export namespace pbsd::net::bpf_jitter {
