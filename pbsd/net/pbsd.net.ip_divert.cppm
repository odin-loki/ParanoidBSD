...
export module pbsd.net.ip_divert;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/ip_divert.c — Ip Divert scaffold.
export namespace pbsd::net::ip_divert {
