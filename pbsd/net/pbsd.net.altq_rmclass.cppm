...
export module pbsd.net.altq_rmclass;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/altq/altq_rmclass.c — Altq Rmclass scaffold.
export namespace pbsd::net::altq_rmclass {
...
} // namespace pbsd::net::altq_rmclass
