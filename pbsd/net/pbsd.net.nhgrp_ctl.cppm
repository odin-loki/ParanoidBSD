...
export module pbsd.net.nhgrp_ctl;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/route/nhgrp_ctl.c — Nhgrp Ctl scaffold.
export namespace pbsd::net::nhgrp_ctl {
