...
export module pbsd.net.altq_subr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/altq/altq_subr.c — Altq Subr scaffold.
export namespace pbsd::net::altq_subr {
