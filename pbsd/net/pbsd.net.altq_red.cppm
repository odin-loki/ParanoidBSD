...
export module pbsd.net.altq_red;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/altq/altq_red.c — Altq Red scaffold.
export namespace pbsd::net::altq_red {
