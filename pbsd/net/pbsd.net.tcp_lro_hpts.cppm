...
export module pbsd.net.tcp_lro_hpts;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/tcp_lro_hpts.c — Tcp Lro Hpts scaffold.
export namespace pbsd::net::tcp_lro_hpts {
...
} // namespace pbsd::net::tcp_lro_hpts
