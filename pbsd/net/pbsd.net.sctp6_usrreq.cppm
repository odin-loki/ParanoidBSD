...
export module pbsd.net.sctp6_usrreq;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet6/sctp6_usrreq.c — Sctp6 Usrreq scaffold.
export namespace pbsd::net::sctp6_usrreq {
...
} // namespace pbsd::net::sctp6_usrreq
