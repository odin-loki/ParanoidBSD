...
export module pbsd.net.ip6_fastfwd;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet6/ip6_fastfwd.c — Ip6 Fastfwd scaffold.
export namespace pbsd::net::ip6_fastfwd {
...
} // namespace pbsd::net::ip6_fastfwd
