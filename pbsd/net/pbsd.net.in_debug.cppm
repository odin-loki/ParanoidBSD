...
export module pbsd.net.in_debug;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/in_debug.c — In Debug scaffold.
export namespace pbsd::net::in_debug {
