...
export module pbsd.net.in_kdtrace;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/in_kdtrace.c — In Kdtrace scaffold.
export namespace pbsd::net::in_kdtrace {
