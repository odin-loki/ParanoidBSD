...
export module pbsd.net.sctp_auth;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/sctp_auth.c — Sctp Auth scaffold.
export namespace pbsd::net::sctp_auth {
