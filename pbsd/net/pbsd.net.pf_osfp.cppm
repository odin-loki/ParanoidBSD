...
export module pbsd.net.pf_osfp;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netpfil/pf/pf_osfp.c — Pf Osfp scaffold.
export namespace pbsd::net::pf_osfp {
