...
export module pbsd.net.bpf_buffer;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/bpf_buffer.c — Bpf Buffer scaffold.
export namespace pbsd::net::bpf_buffer {
