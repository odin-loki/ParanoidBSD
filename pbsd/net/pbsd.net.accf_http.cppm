...
export module pbsd.net.accf_http;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/accf_http/accf_http.c — Accf Http scaffold.
export namespace pbsd::net::accf_http {
