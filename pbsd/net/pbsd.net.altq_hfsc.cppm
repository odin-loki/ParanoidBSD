...
export module pbsd.net.altq_hfsc;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/altq/altq_hfsc.c — Altq Hfsc scaffold.
export namespace pbsd::net::altq_hfsc {
