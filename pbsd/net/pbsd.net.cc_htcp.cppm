...
export module pbsd.net.cc_htcp;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/cc/cc_htcp.c — Cc Htcp scaffold.
export namespace pbsd::net::cc_htcp {
