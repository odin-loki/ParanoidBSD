...
export module pbsd.net.slcompress;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/slcompress.c — Slcompress scaffold.
export namespace pbsd::net::slcompress {
