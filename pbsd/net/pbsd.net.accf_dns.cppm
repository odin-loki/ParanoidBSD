...
export module pbsd.net.accf_dns;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/accf_dns.c — Accf Dns scaffold.
export namespace pbsd::net::accf_dns {
