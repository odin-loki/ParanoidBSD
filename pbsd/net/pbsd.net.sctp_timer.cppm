...
export module pbsd.net.sctp_timer;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/sctp_timer.c — Sctp Timer scaffold.
export namespace pbsd::net::sctp_timer {
