...
export module pbsd.net.cc_cubic;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/cc/cc_cubic.c — Cc Cubic scaffold.
export namespace pbsd::net::cc_cubic {
