...
export module pbsd.net.sctp_output;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/sctp_output.c — Sctp Output scaffold.
export namespace pbsd::net::sctp_output {
...
} // namespace pbsd::net::sctp_output
