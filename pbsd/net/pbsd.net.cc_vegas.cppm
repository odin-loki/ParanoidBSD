...
export module pbsd.net.cc_vegas;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/cc/cc_vegas.c — Cc Vegas scaffold.
export namespace pbsd::net::cc_vegas {
