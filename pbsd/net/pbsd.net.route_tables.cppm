...
export module pbsd.net.route_tables;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/route/route_tables.c — Route Tables scaffold.
export namespace pbsd::net::route_tables {
...
} // namespace pbsd::net::route_tables
