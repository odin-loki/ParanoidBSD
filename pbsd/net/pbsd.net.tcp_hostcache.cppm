...
export module pbsd.net.tcp_hostcache;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/tcp_hostcache.c — Tcp Hostcache scaffold.
export namespace pbsd::net::tcp_hostcache {
...
} // namespace pbsd::net::tcp_hostcache
