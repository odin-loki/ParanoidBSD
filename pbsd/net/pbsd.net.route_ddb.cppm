...
export module pbsd.net.route_ddb;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/route/route_ddb.c — Route Ddb scaffold.
export namespace pbsd::net::route_ddb {
