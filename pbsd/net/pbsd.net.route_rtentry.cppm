...
export module pbsd.net.route_rtentry;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/route_rtentry.c — Route Rtentry scaffold.
export namespace pbsd::net::route_rtentry {
...
} // namespace pbsd::net::route_rtentry
