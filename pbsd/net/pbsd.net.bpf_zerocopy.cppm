...
export module pbsd.net.bpf_zerocopy;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/bpf_zerocopy.c — Bpf Zerocopy scaffold.
export namespace pbsd::net::bpf_zerocopy {
...
} // namespace pbsd::net::bpf_zerocopy
