...
export module pbsd.net.sctputil;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/sctputil.c — Sctputil scaffold.
export namespace pbsd::net::sctputil {
