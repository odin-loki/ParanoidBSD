...
export module pbsd.net.raw_usrreq;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/raw_usrreq.c — Raw Usrreq scaffold.
export namespace pbsd::net::raw_usrreq {
