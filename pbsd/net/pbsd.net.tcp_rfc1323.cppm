...
export module pbsd.net.tcp_rfc1323;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/tcp_subr.c — Tcp Rfc1323 scaffold.
export namespace pbsd::net::tcp_rfc1323 {
...
} // namespace pbsd::net::tcp_rfc1323
