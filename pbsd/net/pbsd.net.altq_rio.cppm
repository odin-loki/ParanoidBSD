...
export module pbsd.net.altq_rio;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/altq/altq_rio.c — Altq Rio scaffold.
export namespace pbsd::net::altq_rio {
