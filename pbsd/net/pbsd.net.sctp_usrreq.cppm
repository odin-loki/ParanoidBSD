...
export module pbsd.net.sctp_usrreq;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/sctp_usrreq.c — Sctp Usrreq scaffold.
export namespace pbsd::net::sctp_usrreq {
...
} // namespace pbsd::net::sctp_usrreq
