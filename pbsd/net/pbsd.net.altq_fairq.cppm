...
export module pbsd.net.altq_fairq;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/altq/altq_fairq.c — Altq Fairq scaffold.
export namespace pbsd::net::altq_fairq {
