...
export module pbsd.net.pf_norm;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netpfil/pf/pf_norm.c — Pf Norm scaffold.
export namespace pbsd::net::pf_norm {
