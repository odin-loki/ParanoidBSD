...
export module pbsd.net.tcp_ratelimit;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/tcp_ratelimit.c — Tcp Ratelimit scaffold.
export namespace pbsd::net::tcp_ratelimit {
...
} // namespace pbsd::net::tcp_ratelimit
