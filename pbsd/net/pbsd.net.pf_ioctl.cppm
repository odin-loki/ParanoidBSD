...
export module pbsd.net.pf_ioctl;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netpfil/pf/pf_ioctl.c — Pf Ioctl scaffold.
export namespace pbsd::net::pf_ioctl {
