...
export module pbsd.net.in_pcblist;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/in_pcb.c — In Pcblist scaffold.
export namespace pbsd::net::in_pcblist {
