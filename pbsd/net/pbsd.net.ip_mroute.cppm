...
export module pbsd.net.ip_mroute;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/ip_mroute.c — Ip Mroute scaffold.
export namespace pbsd::net::ip_mroute {
