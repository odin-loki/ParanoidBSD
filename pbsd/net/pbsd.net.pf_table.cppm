...
export module pbsd.net.pf_table;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netpfil/pf/pf_table.c — Pf Table scaffold.
export namespace pbsd::net::pf_table {
