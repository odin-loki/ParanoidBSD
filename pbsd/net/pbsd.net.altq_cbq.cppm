...
export module pbsd.net.altq_cbq;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/altq/altq_cbq.c — Altq Cbq scaffold.
export namespace pbsd::net::altq_cbq {
