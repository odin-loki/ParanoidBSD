...
export module pbsd.net.rss_config;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/rss_config.c — Rss Config scaffold.
export namespace pbsd::net::rss_config {
