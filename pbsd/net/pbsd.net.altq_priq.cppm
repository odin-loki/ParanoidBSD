...
export module pbsd.net.altq_priq;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/altq/altq_priq.c — Altq Priq scaffold.
export namespace pbsd::net::altq_priq {
