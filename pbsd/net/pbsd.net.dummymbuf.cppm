...
export module pbsd.net.dummymbuf;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/dummymbuf.c — Dummymbuf scaffold.
export namespace pbsd::net::dummymbuf {
