...
export module pbsd.net.debugnet_inet;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/debugnet_inet.c — Debugnet Inet scaffold.
export namespace pbsd::net::debugnet_inet {
...
} // namespace pbsd::net::debugnet_inet
