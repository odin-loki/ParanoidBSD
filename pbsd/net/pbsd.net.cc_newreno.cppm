...
export module pbsd.net.cc_newreno;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/cc/cc_newreno.c — Cc Newreno scaffold.
export namespace pbsd::net::cc_newreno {
