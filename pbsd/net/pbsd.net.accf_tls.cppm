...
export module pbsd.net.accf_tls;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/accf_tls.c — Accf Tls scaffold.
export namespace pbsd::net::accf_tls {
