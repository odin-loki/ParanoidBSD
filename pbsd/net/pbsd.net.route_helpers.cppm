...
export module pbsd.net.route_helpers;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/route_helpers.c — Route Helpers scaffold.
export namespace pbsd::net::route_helpers {
...
} // namespace pbsd::net::route_helpers
