...
export module pbsd.net.sctp_input;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/sctp_input.c — Sctp Input scaffold.
export namespace pbsd::net::sctp_input {
