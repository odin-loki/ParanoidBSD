...
export module pbsd.net.in_fib_dxr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/in_fib_dxr.c — In Fib Dxr scaffold.
export namespace pbsd::net::in_fib_dxr {
