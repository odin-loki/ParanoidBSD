...
export module pbsd.net.nhop_ctl;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/route/nhop_ctl.c — Nhop Ctl scaffold.
export namespace pbsd::net::nhop_ctl {
