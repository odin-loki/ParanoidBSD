...
export module pbsd.net.rip_input;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/netinet/rip_input.c — Rip Input scaffold.
export namespace pbsd::net::rip_input {
