#!/bin/sh
#
# Build and run the b0169 differential test.  Run as `sh build.sh' from
# pbsd/bin/realpath/b0169/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.bin.realpath.b0169
