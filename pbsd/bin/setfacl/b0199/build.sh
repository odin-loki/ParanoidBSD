#!/bin/sh
#
# Build and run the b0199 differential test.  Run as `sh build.sh' from
# pbsd/bin/setfacl/b0199/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.bin.setfacl.b0199
