#!/bin/sh
#
# Build and run the b0171 differential test.  Run as `sh build.sh' from
# pbsd/bin/echo/b0171/.  The harness's exit status is this script's exit
# status.
