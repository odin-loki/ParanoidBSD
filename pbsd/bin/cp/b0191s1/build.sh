...
MODNAME=pbsd.bin.cp.b0191s1
WRAP="-Wl,--wrap=sysconf -Wl,--wrap=malloc -Wl,--wrap=read -Wl,--wrap=write -Wl,--wrap=copy_file_range -Wl,--wrap=close -Wl,--wrap=open -Wl,--wrap=openat -Wl,--wrap=fstat -Wl,--wrap=fstatat -Wl,--wrap=stat -Wl,--wrap=lstat -Wl,--wrap=readlink -Wl,--wrap=unlinkat -Wl,--wrap=linkat -Wl,--wrap=symlinkat -Wl,--wrap=mkfifoat -Wl,--wrap=mknodat -Wl,--wrap=futimens -Wl,--wrap=utimensat -Wl,--wrap=fchown -Wl,--wrap=fchownat -Wl,--wrap=fchmod -Wl,--wrap=fchmodat -Wl,--wrap=fchflags -Wl,--wrap=chflagsat -Wl,--wrap=fpathconf -Wl,--wrap=acl_get_fd_np -Wl,--wrap=acl_is_trivial_np -Wl,--wrap=acl_set_fd_np -Wl,--wrap=acl_free -Wl,--wrap=getchar -Wl,--wrap=exit"
