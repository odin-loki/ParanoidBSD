#!/bin/sh
#
# Build and run the b0166 differential test.  Run as `sh build.sh' from
# pbsd/bin/sync/b0166/.  The harness's exit status is this script's exit
# status.
...
$CXX -std=c++23 $CXXFLAGS -Wl,--wrap=sync -o harness harness.o port.o oracle.o
