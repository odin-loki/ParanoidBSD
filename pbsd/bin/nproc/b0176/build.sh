#!/bin/sh
#
# Build and run the b0176 differential test.  Run as `sh build.sh' from
# pbsd/bin/nproc/b0176/.  The harness's exit status is this script's exit
# status.
