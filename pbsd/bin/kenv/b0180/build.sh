#!/bin/sh
#
# Build and run the b0180 differential test.  Run as `sh build.sh' from
# pbsd/bin/kenv/b0180/.  The harness's exit status is this script's exit
# status.
