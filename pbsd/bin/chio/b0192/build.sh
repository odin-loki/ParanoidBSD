#!/bin/sh
#
# Build and run the b0192 differential test.  Run as `sh build.sh' from
# pbsd/bin/chio/b0192/.  The harness's exit status is this script's exit
# status.
