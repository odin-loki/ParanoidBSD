#!/bin/sh
#
# Build and run the b0163 differential test.  Run as `sh build.sh' from
# pbsd/bin/cat/b0163/.  The harness's exit status is this script's exit
# status.
