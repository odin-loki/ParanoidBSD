#!/bin/sh
#
# Build and run the b0175 differential test.  Run as `sh build.sh' from
# pbsd/bin/sleep/b0175/.  The harness's exit status is this script's exit
# status.
