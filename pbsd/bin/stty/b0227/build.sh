#!/bin/sh
#
# Build and run the b0227 differential test.  Run as `sh build.sh' from
# pbsd/bin/stty/b0227/.  The harness's exit status is this script's exit
# status.
...
$CXX -std=c++23 $CXXFLAGS \
    -Wl,--wrap=usage -Wl,--wrap=warnx -Wl,--wrap=err -Wl,--wrap=ioctl \
