#!/bin/sh
#
# Build and run the b0187s3 differential test.  Run as `sh build.sh' from
# pbsd/bin/stty/b0187s3/.  The harness's exit status is this script's exit
# status.
