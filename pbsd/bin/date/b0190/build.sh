#!/bin/sh
#
# Build and run the b0190 differential test.  Run as `sh build.sh' from
# pbsd/bin/date/b0190/.  The harness's exit status is this script's exit
# status.
