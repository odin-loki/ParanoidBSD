#!/bin/sh
#
# Build and run the b0207 differential test.  Run as `sh build.sh' from
# pbsd/bin/pax/b0207/.  The harness's exit status is this script's exit status.
