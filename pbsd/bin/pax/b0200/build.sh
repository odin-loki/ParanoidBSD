#!/bin/sh
#
# Build and run the b0200 differential test.  Run as `sh build.sh' from
# pbsd/bin/pax/b0200/.  The harness's exit status is this script's exit status.
...
CC=${CC:-cc}
CXX=${CXX:-c++}
CFLAGS=${CFLAGS:--O2 -D_GNU_SOURCE -D_DEFAULT_SOURCE}
CXXFLAGS=${CXXFLAGS:--O2 -D_GNU_SOURCE -D_DEFAULT_SOURCE}

MODNAME=pbsd.bin.pax.b0200
...
$CXX -std=c++23 $CXXFLAGS -o harness harness.o port.o oracle.o -lbsd
