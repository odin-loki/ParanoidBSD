...
main()
{
	...
	test_intcmp_edge();
	std::fprintf(stderr, "T13\n"); fflush(stderr);
	test_intcmp_sweep();
	std::fprintf(stderr, "T14\n"); fflush(stderr);
	test_parser_units();
	std::fprintf(stderr, "T15\n"); fflush(stderr);
	test_syntax_error();
	std::fprintf(stderr, "T16\n"); fflush(stderr);
	test_filstat_edge();
	std::fprintf(stderr, "T17\n"); fflush(stderr);
	test_filstat_sweep();
	std::fprintf(stderr, "T18\n"); fflush(stderr);
	test_newerf_olderf_equalf();
	std::fprintf(stderr, "T19\n"); fflush(stderr);
	test_newerf_sweep();
	std::fprintf(stderr, "T20\n"); fflush(stderr);
	test_main_edge();
	std::fprintf(stderr, "T21\n"); fflush(stderr);
	test_main_bracket();
	std::fprintf(stderr, "T22\n"); fflush(stderr);
	test_main_sweep();
	std::fprintf(stderr, "T23\n"); fflush(stderr);
	test_parser_expr_sweep();
	std::fprintf(stderr, "T24\n"); fflush(stderr);
