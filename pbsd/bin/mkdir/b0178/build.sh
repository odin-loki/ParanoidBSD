#!/bin/sh
#
# Build and run the b0178 differential test.  Run as `sh build.sh' from
# pbsd/bin/mkdir/b0178/.  The harness's exit status is this script's exit
# status.
...
$CXX -std=c++23 $CXXFLAGS -o harness harness.o port.o oracle.o $LIBS
