#!/bin/sh
#
# Build and run the b0177 differential test.  Run as `sh build.sh' from
# pbsd/bin/kill/b0177/.  The harness's exit status is this script's exit
# status.
...
$CXX -std=c++23 $CXXFLAGS -Wl,--wrap=kill -o harness harness.o port.o oracle.o
