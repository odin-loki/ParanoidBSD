#!/bin/sh
#
# Build and run the b0215 differential test.  Run as `sh build.sh' from
# pbsd/bin/dd/b0215/.  The harness's exit status is this script's exit status.
