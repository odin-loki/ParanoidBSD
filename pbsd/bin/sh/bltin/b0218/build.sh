#!/bin/sh
#
# Build and run the b0218 differential test.  Run as `sh build.sh' from
# pbsd/bin/sh/bltin/b0218/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.bin.sh.bltin.b0218
