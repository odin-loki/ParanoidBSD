#!/bin/sh
#
# build.sh -- build and run the PBSD b0119 differential test.
#
# Usage: sh build.sh            (from pbsd/bin/sh/b0119/)
#
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0119_test"

exec "$BUILD/b0119_test"
