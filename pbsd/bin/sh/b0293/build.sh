#!/bin/sh
#
# build.sh -- build and run the PBSD b0293 differential test.
#
# Usage: sh build.sh            (from pbsd/bin/sh/b0293/)
#
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0293_test"

exec "$BUILD/b0293_test"
