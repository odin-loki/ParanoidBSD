#!/bin/sh
#
# Build and run the b0172 differential test.  Run as `sh build.sh' from
# pbsd/bin/rmdir/b0172/.  The harness's exit status is this script's exit
# status.
