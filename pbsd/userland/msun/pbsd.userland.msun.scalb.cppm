...
export module pbsd.userland.msun.scalb;

/// scalb/scalbf from hbsd/src/lib/msun/src/s_scalb.c
export namespace pbsd::userland::msun {

[[nodiscard]] inline double scalb(double x, double fn) noexcept {
...
[[nodiscard]] inline float scalbf(float x, float fn) noexcept {
    const int n = static_cast<int>(fn);
    std::uint32_t hx;
    std::memcpy(&hx, &x, sizeof(hx));
