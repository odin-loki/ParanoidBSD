...
export module pbsd.userland.msun.floor;

/// floor from hbsd/src/lib/msun/src/s_floor.c (bit twiddling, double only)
...
[[nodiscard]] inline double floor(double x) noexcept {
    std::uint32_t i0;
    std::uint32_t i1;
