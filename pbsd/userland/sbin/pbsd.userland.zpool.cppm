...
export module pbsd.userland.zpool;

export import pbsd.core;
export import pbsd.userland.hosted;

/// Port helpers from hbsd/src/sys/contrib/openzfs/cmd/zpool/zpool_main.c — subcommand registry (logic-only).
export namespace pbsd::userland::sbin::zpool {
...
} // namespace pbsd::userland::sbin::zpool
