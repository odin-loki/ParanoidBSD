...
export module pbsd.userland.camcontrol;

export import pbsd.core;
export import pbsd.userland.hosted;

/// Port helpers from hbsd/src/sbin/camcontrol/camcontrol.c — subcommand registry (logic-only).
export namespace pbsd::userland::sbin::camcontrol {
...
[[nodiscard]] inline Result<Subcommand> subcommand_from_name(const char* name) noexcept {
    ...
    static const struct {
        ...
        {"tur", Subcommand::Tur},
        {"inquiry", Subcommand::Inquiry},
        {"devlist", Subcommand::Devlist},
        {"rescan", Subcommand::Rescan},
        {"start", Subcommand::Start},
        {"stop", Subcommand::Stop},
        {"modepage", Subcommand::Modepage},
...
} // namespace pbsd::userland::sbin::camcontrol
