...
CC=${CC:-cc}
CXX=${CXX:-c++}
MODULE_NAME=pbsd.sys.fs.deadfs.b0213
rm -rf gcm.cache b0213_run oracle.o port.o harness.o "$MODULE_NAME.pcm"
...
if $CXX --version 2>&1 | grep -qi clang; then
	...
	$CXX -std=c++23 oracle.o port.o harness.o -o b0213_run
else
	...
	$CXX -std=c++23 -fmodules-ts oracle.o port.o harness.o -o b0213_run
fi
exec ./b0213_run
