#!/bin/sh
# Build and run the differential test for PBSD batch b0205.
...
CC=${CC:-cc}
CXX=${CXX:-c++}
MODULE_NAME=pbsd.sys.fs.fifofs.b0205

rm -rf gcm.cache b0205_run oracle.o port.o harness.o "$MODULE_NAME.pcm"
...
if $CXX --version 2>&1 | grep -qi clang; then
	...
	$CXX -std=c++23 oracle.o port.o harness.o -o b0205_run
else
	...
	$CXX -std=c++23 -fmodules-ts oracle.o port.o harness.o -o b0205_run
fi
