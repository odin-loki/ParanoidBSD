#!/bin/sh
# Build and run the differential test for PBSD batch b0146s3.
...
CC=${CC:-cc}
CXX=${CXX:-c++}
MODULE_NAME=pbsd.sys.kern.b0146s3

rm -rf gcm.cache b0146s3_run oracle.o port.o harness.o "$MODULE_NAME.pcm"
...
if $CXX --version 2>&1 | grep -qi clang; then
	...
	$CXX -std=c++23 oracle.o port.o harness.o -o b0146s3_run
else
	...
	$CXX -std=c++23 -fmodules-ts oracle.o port.o harness.o -o b0146s3_run
fi
