#!/bin/sh
# Build and run the differential test for PBSD batch b0217.
# Usage: sh build.sh   (from pbsd/sys/kern/b0217/)
...
CC=${CC:-cc}
CXX=${CXX:-c++}
MODULE_NAME=pbsd.sys.kern.b0217

rm -rf gcm.cache b0217_run oracle.o port.o harness.o "$MODULE_NAME.pcm"
...
if $CXX --version 2>&1 | grep -qi clang; then
	...
	$CXX -std=c++23 -D_POSIX_C_SOURCE=200809L oracle.o port.o harness.o \
	    -Wl,--wrap=printf -lm -lpthread -o b0217_run
else
