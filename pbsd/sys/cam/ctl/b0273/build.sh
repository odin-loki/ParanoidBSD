...
CC=${CC:-cc}
CXX=${CXX:-c++}
MODULE_NAME=pbsd.sys.cam.ctl.b0273
rm -rf gcm.cache b0273_run oracle.o port.o harness.o "$MODULE_NAME.pcm"
...
if $CXX --version 2>&1 | grep -qi clang; then
	...
	$CXX -std=c++23 oracle.o port.o harness.o -o b0273_run
else
	...
	$CXX -std=c++23 -fmodules-ts oracle.o port.o harness.o -o b0273_run
fi
exec ./b0273_run
