/*
 * harness.cpp -- differential test for PBSD batch b0029s1.
 *
 * Batch b0029s1 consists of the single source file
 * hbsd/src/sys/security/mac_veriexec/mac_veriexec_sha384.c, which defines no
...
import pbsd.sys.security.mac.veriexec.b0029s1;
...
main(void)
{
	std::printf("PBSD batch b0029s1 differential test\n");
	...
	std::printf("mac_veriexec_sha384.c defines no functions; see "
	    "skipped.txt.\n");
