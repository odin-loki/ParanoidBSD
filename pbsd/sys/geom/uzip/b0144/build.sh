#!/bin/sh
#
# Build and run the b0144 differential test.  Run as `sh build.sh' from
# pbsd/sys/geom/uzip/b0144/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.sys.geom.uzip.b0144
