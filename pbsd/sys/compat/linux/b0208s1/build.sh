#!/bin/sh
#
# Build and run the b0208s1 differential test.  Run as `sh build.sh' from
# pbsd/sys/compat/linux/b0208s1/.  The harness's exit status is this script's
# exit status.
...
MODNAME=pbsd.sys.compat.linux.b0208s1
