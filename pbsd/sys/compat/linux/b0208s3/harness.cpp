/*
 * harness.cpp -- differential test for PBSD batch b0208s3.
 *
 * Batch b0208s3 consists of the single source file
 * sys/compat/linux/linux_elf64.c, which defines no functions: its entire body
 * is `#define __ELF_WORD_SIZE 64' and `#include <compat/linux/linux_elf.c>'.
 * The included file is a separate translation unit not part of this batch, so
 * both were recorded in skipped.txt instead of being ported.  port.cppm exports
...
import pbsd.sys.compat.linux.b0208s3;
...
int main()
{
	std::printf("PBSD batch b0208s3 differential test\n");
	...
	std::printf("linux_elf64.c defines no functions; see skipped.txt.\n");
