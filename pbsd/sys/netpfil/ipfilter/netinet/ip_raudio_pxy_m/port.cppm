// PBSD -- mechanical C++23 port of ip_raudio_pxy.c, proven equivalent to
// the original C by LLVM IR comparison. Generated by pbsd.py.
module;


export module pbsd.sys.netpfil.ipfilter.netinet.ip_raudio_pxy;

export namespace pbsd::sys::netpfil::ipfilter::netinet::ip_raudio_pxy {
...
}  // namespace pbsd::sys::netpfil::ipfilter::netinet::ip_raudio_pxy
