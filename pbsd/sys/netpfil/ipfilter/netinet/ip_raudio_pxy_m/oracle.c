...
void ref_ipf_p_raudio_main_load(void);
void ref_ipf_p_raudio_main_unload(void);
int ref_ipf_p_raudio_new(void *, fr_info_t *, ap_session_t *, nat_t *);
int ref_ipf_p_raudio_in(void *, fr_info_t *, ap_session_t *, nat_t *);
int ref_ipf_p_raudio_out(void *, fr_info_t *, ap_session_t *, nat_t *);
 ...
 */
void
ref_ipf_p_raudio_main_load(void)
{
...
void
ref_ipf_p_raudio_main_unload(void)
{
 ...
 */
int
ref_ipf_p_raudio_new(void *arg, fr_info_t *fin, ap_session_t *aps, nat_t *nat __unused)
{
	raudio_t *rap;
...
int
ref_ipf_p_raudio_out(void *arg, fr_info_t *fin, ap_session_t *aps, nat_t *nat __unused)
{
...
int
ref_ipf_p_raudio_in(void *arg, fr_info_t *fin, ap_session_t *aps, nat_t *nat)
{
