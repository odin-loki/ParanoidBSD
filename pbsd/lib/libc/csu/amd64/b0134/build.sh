#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0134 differential test.
#
# Run as:  sh build.sh
#
...
modname=pbsd.lib.libc.csu.amd64.b0134
...
echo "building batch b0134 with $CC / $CXX ($compiler modules)"
