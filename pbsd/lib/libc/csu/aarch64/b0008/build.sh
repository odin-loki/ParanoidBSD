#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0008 differential test.
#
# Run as:  sh build.sh
#
...
modname=pbsd.lib.libc.csu.aarch64.b0008
...
echo "building batch b0008 with $CC / $CXX ($compiler modules)"
