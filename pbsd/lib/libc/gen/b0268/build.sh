#!/bin/sh
#
# Build and run the b0268 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gen/b0268/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.gen.b0268
...
$CXX -std=c++23 $CXXFLAGS -Wl,--wrap=syslog -o harness harness.o port.o oracle.o
