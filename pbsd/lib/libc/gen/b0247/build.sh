#!/bin/sh
#
# Build and run the b0247 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gen/b0247/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.gen.b0247
