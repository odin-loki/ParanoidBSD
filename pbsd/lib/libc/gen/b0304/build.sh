#!/bin/sh
#
# Build and run the b0304 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gen/b0304/.  The harness exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.gen.b0304
