#!/bin/sh
#
# Build and run the b0248 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gen/b0248/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.gen.b0248
...
$CXX -std=c++23 $CXXFLAGS -o harness harness.o port.o oracle.o \
    -Wl,--wrap=devname -Wl,--wrap=devname_r
