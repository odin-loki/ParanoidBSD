#!/bin/sh
#
# Build and run the b0125 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gen/b0125/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.gen.b0125
