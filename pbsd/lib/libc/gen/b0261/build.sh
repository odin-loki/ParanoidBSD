#!/bin/sh
#
# Build and run the b0261 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gen/b0261/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.gen.b0261
