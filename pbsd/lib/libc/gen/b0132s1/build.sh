#!/bin/sh
#
# Build and run the b0132s1 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gen/b0132s1/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.gen.b0132s1
...
$CXX -std=c++23 $CXXFLAGS -o harness harness.o port.o oracle.o -lpthread
