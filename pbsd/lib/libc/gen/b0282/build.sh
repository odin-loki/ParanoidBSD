#!/bin/sh
#
# Build and run the b0282 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gen/b0282/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.gen.b0282
...
$CXX -std=c++23 $CXXFLAGS \
    ...
    -Wl,--wrap=sysconf -Wl,--wrap=getgrouplist -Wl,--wrap=setgroups \
