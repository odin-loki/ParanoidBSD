#!/bin/sh
#
# Build and run the b0015 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gen/b0015/.  The exit status is the harness's exit status.
...
MODNAME=pbsd.lib.libc.gen.b0015
