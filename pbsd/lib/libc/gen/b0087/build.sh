#!/bin/sh
#
# Build and run the b0087 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gen/b0087/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.gen.b0087
