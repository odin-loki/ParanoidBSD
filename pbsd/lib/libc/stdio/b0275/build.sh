#!/bin/sh
#
# Build and run the b0275 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/stdio/b0275/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.stdio.b0275
