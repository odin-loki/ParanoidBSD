#!/bin/sh
#
# Build and run the b0106s3 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/stdio/b0106s3/.  The harness's exit status is this script's
# exit status.
...
MODNAME=pbsd.lib.libc.stdio.b0106s3
