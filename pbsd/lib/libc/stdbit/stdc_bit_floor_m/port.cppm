// PBSD -- mechanical C++23 port of stdc_bit_floor.c, proven equivalent to
// the original C by LLVM IR comparison. Generated by pbsd.py.
module;
#include <limits.h>
#include <stdbit.h>

export module pbsd.lib.libc.stdbit.stdc_bit_floor;

export namespace pbsd::lib::libc::stdbit::stdc_bit_floor {
...
}  // namespace pbsd::lib::libc::stdbit::stdc_bit_floor
