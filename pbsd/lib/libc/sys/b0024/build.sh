#!/bin/sh
# Build and run the b0024 differential test.
# Usage:  sh build.sh   (from pbsd/lib/libc/sys/b0024/)
...
-fmodules)
	$CXX $CXXFLAGS $MODFLAGS --precompile -x c++-module port.cppm \
	    -o pcm.cache/pbsd.lib.libc.sys.b0024.pcm
	$CXX $CXXFLAGS $MODFLAGS -c \
	    pcm.cache/pbsd.lib.libc.sys.b0024.pcm -o port.o
	$CXX $CXXFLAGS $MODFLAGS \
	    -fmodule-file=pbsd.lib.libc.sys.b0024=pcm.cache/pbsd.lib.libc.sys.b0024.pcm \
