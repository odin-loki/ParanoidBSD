#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0120 differential test.
#
# Run as:  sh build.sh
#
...
modname=pbsd.lib.libc.amd64.string.b0120
...
echo "building batch b0120 with $CC / $CXX ($compiler modules)"
