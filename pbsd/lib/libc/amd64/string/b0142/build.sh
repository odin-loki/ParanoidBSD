#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0142 differential test.
#
# Run as:  sh build.sh
#
...
modname=pbsd.lib.libc.amd64.string.b0142
...
echo "building batch b0142 with $CC / $CXX ($compiler modules)"
