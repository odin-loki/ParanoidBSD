#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0081 differential test.
#
# Run as:  sh build.sh
#
...
modname=pbsd.lib.libc.amd64.string.b0081
...
echo "building batch b0081 with $CC / $CXX ($compiler modules)"
