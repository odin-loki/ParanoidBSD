#!/bin/sh
# Build and run the b0129 differential test.
# Usage: sh build.sh   (from pbsd/lib/libc/net/b0129/)
set -e
...
MODULE=pbsd.lib.libc.net.b0129
OBJDIR=./.b0129-obj
...
$CXX $CXXFLAGS $MODFLAGS "$OBJDIR/harness.o" "$OBJDIR/port.o" \
    "$OBJDIR/oracle.o" -o "$OBJDIR/b0129_test"

exec "$OBJDIR/b0129_test"
