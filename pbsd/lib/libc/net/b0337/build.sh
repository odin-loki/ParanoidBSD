#!/bin/sh
#
# Build and run the b0337 differential test.  Run as `sh build.sh` from
# pbsd/lib/libc/net/b0337/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.net.b0337
...
$CXX -std=c++23 $CXXFLAGS -o harness harness.o port.o oracle.o -lresolv
