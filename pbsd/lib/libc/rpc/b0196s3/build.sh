#!/bin/sh
# Build and run the b0196s3 differential test.
# Usage: sh build.sh   (from pbsd/lib/libc/rpc/b0196s3/)
set -e
...
MODULE=pbsd.lib.libc.rpc.b0196s3
OBJDIR=./.b0196s3-obj
...
$CXX $CXXFLAGS $MODFLAGS "$OBJDIR/harness.o" "$OBJDIR/port.o" \
    "$OBJDIR/oracle.o" -o "$OBJDIR/b0196s3_test"

exec "$OBJDIR/b0196s3_test"
