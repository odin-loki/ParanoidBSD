...
export enum clnt_stat { RPC_SUCCESS = 0 };
export struct rpc_err { int re_status; };
...
#endif
inline constexpr once_t ONCE_INITIALIZER = PTHREAD_ONCE_INITIALIZER;
...
export struct rpc_createerr port_rpc_createerr;
