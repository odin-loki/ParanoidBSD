#!/bin/sh
# Build and run the b0196s4 differential test.
# Usage: sh build.sh   (from pbsd/lib/libc/rpc/b0196s4/)
set -e
...
MODULE=pbsd.lib.libc.rpc.b0196s4
OBJDIR=./.b0196s4-obj
...
$CXX $CXXFLAGS $MODFLAGS "$OBJDIR/harness.o" "$OBJDIR/port.o" \
    "$OBJDIR/oracle.o" -o "$OBJDIR/b0196s4_test"

exec "$OBJDIR/b0196s4_test"
