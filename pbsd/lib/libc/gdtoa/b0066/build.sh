#!/bin/sh
#
# Build and run the b0066 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gdtoa/b0066/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.gdtoa.b0066
ROOT=$(cd ../../../../.. && pwd)
HBSD=$ROOT/hbsd/src
