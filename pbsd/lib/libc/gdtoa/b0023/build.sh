#!/bin/sh
#
# Build and run the b0023 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/gdtoa/b0023/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.gdtoa.b0023
...
$CXX -std=c++23 $CXXFLAGS -o harness harness.o port.o oracle.o -pthread
