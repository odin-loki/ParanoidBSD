#!/bin/sh
#
# build.sh -- build and run the PBSD b0158 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/string/b0158/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.string.b0158
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0158_test"

exec "$BUILD/b0158_test"
