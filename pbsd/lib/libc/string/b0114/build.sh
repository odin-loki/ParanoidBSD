#!/bin/sh
#
# build.sh -- build and run the PBSD b0114 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/string/b0114/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.string.b0114
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0114_test"

exec "$BUILD/b0114_test"
