#!/bin/sh
#
# build.sh -- build and run the PBSD b0113 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/string/b0113/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.string.b0113
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0113_test"

exec "$BUILD/b0113_test"
