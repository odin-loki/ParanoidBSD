#!/bin/sh
#
# build.sh -- build and run the PBSD b0137 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/string/b0137/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.string.b0137
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0137_test"

exec "$BUILD/b0137_test"
