#!/bin/sh
#
# build.sh -- build and run the PBSD b0239 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/string/b0239/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.string.b0239
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0239_test"

exec "$BUILD/b0239_test"
