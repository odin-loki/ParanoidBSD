#!/bin/sh
#
# build.sh -- build and run the PBSD b0257 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/string/b0257/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.string.b0257
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0257_test"

exec "$BUILD/b0257_test"
