#!/bin/sh
#
# build.sh -- build and run the PBSD b0116 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/string/b0116/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.string.b0116
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0116_test"

exec "$BUILD/b0116_test"
