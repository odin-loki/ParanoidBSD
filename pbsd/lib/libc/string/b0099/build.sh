#!/bin/sh
#
# build.sh -- build and run the PBSD b0099 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/string/b0099/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.string.b0099
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0099_test"

exec "$BUILD/b0099_test"
