#!/bin/sh
#
# build.sh -- build and run the PBSD b0313 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/string/b0313/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.string.b0313
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0313_test"

exec "$BUILD/b0313_test"
