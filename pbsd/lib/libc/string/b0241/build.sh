#!/bin/sh
#
# build.sh -- build and run the PBSD b0241 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/string/b0241/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.string.b0241
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0241_test"

exec "$BUILD/b0241_test"
