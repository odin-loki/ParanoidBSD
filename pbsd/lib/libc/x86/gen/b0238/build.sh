#!/bin/sh
#
# Build and run the b0238 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/x86/gen/b0238/.  The harness exit status is this script's
# exit status.
...
MODNAME=pbsd.lib.libc.x86.gen.b0238
