#!/bin/sh
#
# Build and run the b0290 differential test.  Run as `sh build.sh` from
# pbsd/lib/libc/inet/b0290/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.inet.b0290
