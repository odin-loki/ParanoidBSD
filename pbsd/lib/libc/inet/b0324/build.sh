#!/bin/sh
#
# Build and run the b0324 differential test.  Run as `sh build.sh` from
# pbsd/lib/libc/inet/b0324/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.inet.b0324
