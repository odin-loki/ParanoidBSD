#!/bin/sh
#
# Build and run the b0283 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/inet/b0283/.  The harness's exit status is this script's exit
# status.
...
MODNAME=pbsd.lib.libc.inet.b0283
