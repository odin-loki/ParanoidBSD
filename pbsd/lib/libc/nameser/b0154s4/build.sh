#!/bin/sh
# b0154s4 — build the C oracle, the C++23 port module and the differential
...
CXX=${CXX:-c++}
BUILD=${BUILD:-build}
MODNAME=pbsd.lib.libc.nameser.b0154s4
...
echo "== link"
$CXX $CXXFLAGS -o "$BUILD/b0154s4_test" "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o"

echo "== run"
exec "$BUILD/b0154s4_test"
