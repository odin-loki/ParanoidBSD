#!/bin/sh
#
# Build and run the b0075 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/locale/b0075/.  The exit status is the harness's exit status.
...
MODNAME=pbsd.lib.libc.locale.b0075
