#!/bin/sh
#
# Build and run the b0153s2 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/locale/b0153s2/.  The exit status is the harness's exit status.
...
MODNAME=pbsd.lib.libc.locale.b0153s2
...
$CXX -std=c++23 $CXXFLAGS -Wl,--wrap=malloc -o harness harness.o port.o oracle.o
