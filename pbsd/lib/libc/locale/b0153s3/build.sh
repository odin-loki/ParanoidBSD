#!/bin/sh
#
# Build and run the b0153s3 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/locale/b0153s3/.  The exit status is the harness's exit status.
...
MODNAME=pbsd.lib.libc.locale.b0153s3
