#!/bin/sh
#
# Build and run the b0156s2 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/locale/b0156s2/.  The exit status is the harness's exit status.
...
MODNAME=pbsd.lib.libc.locale.b0156s2
