/*
 * PBSD batch b0016s1 -- C++23 port of lib/libc/softfloat/lttf2.c.
 *
 * The batch source is lttf2.c.  The SoftFloat machinery it is compiled
 * against (the float128 format, float_raise(), lt128() and float128_lt())
...
export module pbsd.lib.libc.softfloat.b0016s1;

export namespace pbsd::lib_libc_softfloat::b0016s1 {
...
/*
-------------------------------------------------------------------------------
lttf2.c: __lttf2(), the GCC-facing float128 "less than" helper.
-------------------------------------------------------------------------------
*/
flag __lttf2(float128 a, float128 b);
...
} // namespace pbsd::lib_libc_softfloat::b0016s1
