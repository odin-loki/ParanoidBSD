#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0010s2 differential test.
#
# Run as:  sh build.sh
#
...
modname=pbsd.lib.libc.softfloat.b0010s2
...
echo "building batch b0010s2 with $CC / $CXX ($compiler modules)"
