/*
 * oracle.c -- reference (specification) build for PBSD batch b0016s4.
 *
 * Contents:
 *   lib/libc/softfloat/letf2.c            -- the batch source
 *
...
/*
 * ---------------------------------------------------------------------------
 * bits64/softfloat.c: extractFloat128* and float128_le().
 * ---------------------------------------------------------------------------
 */
 ...
 * lib/libc/softfloat/letf2.c -- the batch source.
 *
 * softfloat-for-gcc.h renames float128_le to __letf2; the body below is
 * exactly as it appears in letf2.c.
 * ---------------------------------------------------------------------------
 */
