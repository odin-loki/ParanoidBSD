#!/bin/sh
# PBSD migration batch b0339 -- build and run the differential test.
# Usage: sh build.sh   (from pbsd/lib/libc/softfloat/b0339/)
...
if $CXX --version 2>&1 | grep -qi clang; then
	...
	$CXX $CXXFLAGS -fmodule-file=pbsd.lib.libc.softfloat.b0339=port.pcm \
