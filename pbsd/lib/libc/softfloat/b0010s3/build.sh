#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0010s3 differential test.
#
# Run as:  sh build.sh
#
...
modname=pbsd.lib.libc.softfloat.b0010s3
...
echo "building batch b0010s3 with $CC / $CXX ($compiler modules)"
