#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0009 differential test.
#
# Run as:  sh build.sh
#
...
modname=pbsd.lib.libc.softfloat.b0009
...
echo "building batch b0009 with $CC / $CXX ($compiler modules)"
