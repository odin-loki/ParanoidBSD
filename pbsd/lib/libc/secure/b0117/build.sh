#!/bin/sh
#
# build.sh -- build and run the PBSD b0117 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/secure/b0117/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.secure.b0117
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0117_test"

exec "$BUILD/b0117_test"
