#!/bin/sh
#
# build.sh -- build and run the PBSD b0117s1 differential test.
#
# Usage: sh build.sh            (from pbsd/lib/libc/secure/b0117s1/)
#
...
BUILD=build
MODNAME=pbsd.lib.libc.secure.b0117s1
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0117s1_test"

exec "$BUILD/b0117s1_test"
