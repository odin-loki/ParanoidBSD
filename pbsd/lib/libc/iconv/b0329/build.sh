#!/bin/sh
#
# Build and run the b0329 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/iconv/b0329/.  The exit status is the harness's exit status.
...
MODNAME=pbsd.lib.libc.iconv.b0329
