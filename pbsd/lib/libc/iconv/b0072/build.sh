#!/bin/sh
# Build and run the b0072 differential test.
# Usage:  sh build.sh   (from pbsd/lib/libc/iconv/b0072/)
...
-fmodules)
	$CXX $CXXFLAGS $MODFLAGS --precompile -x c++-module port.cppm \
	    -o pcm.cache/pbsd.lib.libc.iconv.b0072.pcm
	$CXX $CXXFLAGS $MODFLAGS -c \
	    pcm.cache/pbsd.lib.libc.iconv.b0072.pcm -o port.o
	$CXX $CXXFLAGS $MODFLAGS \
	    -fmodule-file=pbsd.lib.libc.iconv.b0072=pcm.cache/pbsd.lib.libc.iconv.b0072.pcm \
