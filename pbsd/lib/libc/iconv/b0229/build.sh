#!/bin/sh
#
# Build and run the b0229 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/iconv/b0229/.  The exit status is the harness's exit status.
...
MODNAME=pbsd.lib.libc.iconv.b0229
