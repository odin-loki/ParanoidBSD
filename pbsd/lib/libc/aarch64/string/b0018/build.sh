#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0018 differential test.
#
# Run as:  sh build.sh
#
...
modname=pbsd.lib.libc.aarch64.string.b0018
...
echo "building batch b0018 with $CC / $CXX ($compiler modules)"
