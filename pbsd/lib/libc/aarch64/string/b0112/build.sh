#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0112 differential test.
#
# Run as:  sh build.sh
#
...
modname=pbsd.lib.libc.aarch64.string.b0112
...
echo "building batch b0112 with $CC / $CXX ($compiler modules)"
