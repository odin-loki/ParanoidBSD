#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0022 differential test.
#
# Run as:  sh build.sh
#
...
modname=pbsd.lib.libc.aarch64.gen.b0022
...
echo "building batch b0022 with $CC / $CXX ($compiler modules)"
