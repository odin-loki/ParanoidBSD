#!/bin/sh
#
# Build and run the b0110 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/posix1e/b0110/.  The harness's exit status is this script's
# exit status.
...
MODNAME=pbsd.lib.libc.posix1e.b0110
