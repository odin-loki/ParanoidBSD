#!/bin/sh
#
# build.sh -- build and run the PBSD batch b0259 differential test.
#
...
MODNAME=pbsd.lib.libc.posix1e.b0259
OUT=b0259_harness
...
$CXX $CXXFLAGS -o "$OUT" harness.o port.o oracle.o -Wl,--wrap=free
