#!/bin/sh
#
# Build and run the b0203 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/db/test/b0203/.  The harness's exit status is this script's
# exit status.
...
MODNAME=pbsd.lib.libc.db.test.b0203
