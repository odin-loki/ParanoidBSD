#!/bin/sh
#
# Build and run the b0289 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/db/test/btree.tests/b0289/.  The harness's exit status is
...
MODNAME=pbsd.lib.libc.db.test.btree.tests.b0289
