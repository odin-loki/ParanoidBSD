#!/bin/sh
#
# Build and run the b0184 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/db/test/hash.tests/b0184/.  The harness's exit status is this
...
MODNAME=pbsd.lib.libc.db.test.hash.tests.b0184
