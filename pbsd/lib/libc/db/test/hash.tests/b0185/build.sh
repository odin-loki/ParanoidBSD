#!/bin/sh
#
# Build and run the b0185 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc/db/test/hash.tests/b0185/.  The harness's exit status is this
...
MODNAME=pbsd.lib.libc.db.test.hash.tests.b0185
