#!/bin/sh
#
# Build and run the b0004 differential test.  Run as `sh build.sh' from
# pbsd/lib/libc_nonshared/b0004/.  The harness's exit status is this script's
# exit status.
...
MODNAME=pbsd.lib.libc.nonshared.b0004
