#!/bin/sh
#
# Build and run the b0111 differential test.  Run as `sh build.sh' from
# pbsd/lib/libthr/arch/amd64/amd64/b0111/.  The harness's exit status is this
...
MODNAME=pbsd.lib.libthr.arch.amd64.amd64.b0111
