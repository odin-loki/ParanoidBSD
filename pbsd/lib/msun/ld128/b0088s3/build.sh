...
CFLAGS="-std=c11 -O2 -ffp-contract=off $LD128FLAG"
CXXFLAGS="-std=c++23 -O2 -ffp-contract=off $LD128FLAG"
...
if $CXX --version 2>&1 | grep -qi clang; then
	$CXX $CXXFLAGS -x c++-module --precompile port.cppm \
	    -o pcm.cache/pbsd.lib.msun.ld128.b0088s3.pcm
	$CXX $CXXFLAGS -c pcm.cache/pbsd.lib.msun.ld128.b0088s3.pcm -o port.o
	$CXX $CXXFLAGS \
	    -fmodule-file=pbsd.lib.msun.ld128.b0088s3=pcm.cache/pbsd.lib.msun.ld128.b0088s3.pcm \
