#!/bin/sh
# Build and run the PBSD batch b0093s2 differential test.
#
# Usage: sh build.sh   (from pbsd/lib/msun/ld80/b0093s2/)
...
if $CXX --version 2>&1 | grep -qi clang; then
	$CXX $CXXFLAGS -x c++-module --precompile port.cppm \
	    -o pcm.cache/pbsd.lib.msun.ld80.b0093s2.pcm
	$CXX $CXXFLAGS -c pcm.cache/pbsd.lib.msun.ld80.b0093s2.pcm -o port.o
	$CXX $CXXFLAGS \
	    -fmodule-file=pbsd.lib.msun.ld80.b0093s2=pcm.cache/pbsd.lib.msun.ld80.b0093s2.pcm \
