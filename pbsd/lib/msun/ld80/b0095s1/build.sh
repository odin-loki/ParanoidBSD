#!/bin/sh
# Build and run the PBSD batch b0095s1 differential test.
#
# Usage: sh build.sh   (from pbsd/lib/msun/ld80/b0095s1/)
...
MOD="pbsd.lib.msun.ld80.b0095s1"

# Pick whichever spelling of the C++ modules switch this toolchain wants.
MODFLAG=""
