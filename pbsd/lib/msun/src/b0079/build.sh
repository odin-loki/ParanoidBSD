#!/bin/sh
# Build and run the differential test for PBSD batch b0079.
# Usage: sh build.sh   (from pbsd/lib/msun/src/b0079/)
...
CC=${CC:-cc}
CXX=${CXX:-c++}
MODULE_NAME=pbsd.lib.msun.src.b0079

rm -rf gcm.cache b0079_run oracle.o port.o harness.o "$MODULE_NAME.pcm"

# The oracle is plain C11; _GNU_SOURCE exposes lgammaf_r and signgam.
...
if $CXX --version 2>&1 | grep -qi clang; then
	...
	$CXX -std=c++23 oracle.o port.o harness.o -o b0079_run -lm
else
