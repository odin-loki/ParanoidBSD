#!/bin/sh
# Build and run the differential test for PBSD batch b0141.
# Usage: sh build.sh   (from pbsd/lib/msun/src/b0141/)
...
CC=${CC:-cc}
CXX=${CXX:-c++}
MODULE_NAME=pbsd.lib.msun.src.b0141

rm -rf gcm.cache b0141_run oracle.o port.o harness.o "$MODULE_NAME.pcm"
...
if $CXX --version 2>&1 | grep -qi clang; then
	...
	$CXX -std=c++23 oracle.o port.o harness.o -o b0141_run -lm
else
