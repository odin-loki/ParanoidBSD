// PBSD -- mechanical C++23 port of s_nexttowardf.c, proven equivalent to
...
export module pbsd.lib.msun.src.s_nexttowardf;

export namespace pbsd::lib::msun::src::s_nexttowardf {
...
}  // namespace pbsd::lib::msun::src::s_nexttowardf
