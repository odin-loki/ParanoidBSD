; ModuleID = '/tmp/port-c9e31d.pcm'
source_filename = "/tmp/port-c9e31d.pcm"
...
define dso_local noundef float @_ZN4pbsd3lib4msun3src15s_fmaximum_numfW4pbsdW3libW4msunW3srcW15s_fmaximum_numf13fmaximum_numfEff(float noundef %x, float noundef %y) local_unnamed_addr #0 {
entry:
...
define void @_ZGIW4pbsdW3libW4msunW3srcW15s_fmaximum_numf() local_unnamed_addr #2 section ".text.startup" {
entry:
  ret void
}

attributes #0 = { mustprogress nofree norecurse nounwind memory(inaccessiblemem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
