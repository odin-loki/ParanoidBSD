// PBSD -- mechanical C++23 port of e_powf.c, proven equivalent to
// the original C by LLVM IR comparison. Generated by pbsd.py.
module;
#include "math.h"
#include "math_private.h"

export module pbsd.lib.msun.src.e_powf;

export namespace pbsd::lib::msun::src::e_powf {
...
}  // namespace pbsd::lib::msun::src::e_powf
