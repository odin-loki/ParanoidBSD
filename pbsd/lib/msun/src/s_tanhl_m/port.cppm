// PBSD -- mechanical C++23 port of s_tanhl.c, proven equivalent to
...
export module pbsd.lib.msun.src.s_tanhl;

export namespace pbsd::lib::msun::src::s_tanhl {
...
}  // namespace pbsd::lib::msun::src::s_tanhl
