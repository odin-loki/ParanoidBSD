// PBSD -- mechanical C++23 port of e_hypotl.c, proven equivalent to
...
export module pbsd.lib.msun.src.e_hypotl;

export namespace pbsd::lib::msun::src::e_hypotl {
...
}  // namespace pbsd::lib::msun::src::e_hypotl
