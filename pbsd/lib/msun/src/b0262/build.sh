#!/bin/sh
# Build and run the differential test for PBSD batch b0262.
# Usage: sh build.sh   (from pbsd/lib/msun/src/b0262/)
...
CC=${CC:-cc}
CXX=${CXX:-c++}
MODULE_NAME=pbsd.lib.msun.src.b0262

rm -rf gcm.cache b0262_run oracle.o port.o harness.o "$MODULE_NAME.pcm"
...
if $CXX --version 2>&1 | grep -qi clang; then
	...
	$CXX -std=c++23 oracle.o port.o harness.o -o b0262_run -lm
else
