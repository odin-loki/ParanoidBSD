#!/bin/sh
# Build and run the differential test for PBSD batch b0079s1.
# Usage: sh build.sh   (from pbsd/lib/msun/src/b0079s1/)
...
CC=${CC:-cc}
CXX=${CXX:-c++}
MODULE_NAME=pbsd.lib.msun.src.b0079s1
...
if $CXX --version 2>&1 | grep -qi clang; then
	...
	$CXX -std=c++23 $MODFLAG -x c++ -c port.cppm -o port.o
	$CXX -std=c++23 $MODFLAG -c harness.cpp -o harness.o
