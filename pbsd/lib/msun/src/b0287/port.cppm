// PBSD port of HardenedBSD lib/msun/src batch b0287.
//
...
export module pbsd.lib.msun.src.b0287;

namespace pbsd::lib_msun_src::b0287 {
...
static inline void extract_words(int32_t &ix0, u_int32_t &ix1, double d)
{
...
static inline void get_high_word(int32_t &i, double d)
{
...
static inline void set_high_word(double &d, int32_t v)
{
...
static inline void set_low_word(double &d, u_int32_t v)
{
...
static inline void insert_words(double &d, int32_t ix0, u_int32_t ix1)
{
...
#define GET_HIGH_WORD(i,d)		get_high_word((i),(d))
#define SET_HIGH_WORD(d,v)		set_high_word((d),(v))
#define SET_LOW_WORD(d,v)		set_low_word((d),(v))
