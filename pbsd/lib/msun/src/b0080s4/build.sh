#!/bin/sh
# Build and run the PBSD batch b0080s4 differential test.
#
# Usage: sh build.sh   (from pbsd/lib/msun/src/b0080s4/)
...
if $CXX --version 2>&1 | grep -qi clang; then
	$CXX $CXXFLAGS -x c++-module --precompile port.cppm \
	    -o pcm.cache/pbsd.lib.msun.src.b0080s4.pcm
	$CXX $CXXFLAGS -c pcm.cache/pbsd.lib.msun.src.b0080s4.pcm -o port.o
	$CXX $CXXFLAGS \
	    -fmodule-file=pbsd.lib.msun.src.b0080s4=pcm.cache/pbsd.lib.msun.src.b0080s4.pcm \
