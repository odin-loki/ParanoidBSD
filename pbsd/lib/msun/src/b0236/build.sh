#!/bin/sh
# Build and run the b0236 differential test.
# Usage: sh build.sh   (from pbsd/lib/msun/src/b0236/)
#
...
if $CXX --version 2>&1 | grep -qi clang; then
	...
	$CXX -std=c++23 -O2 -x c++-module "$SRC/port.cppm" --precompile \
		-o pbsd.lib.msun.src.b0236.pcm
	$CXX -std=c++23 -O2 -c pbsd.lib.msun.src.b0236.pcm -o port.o
	$CXX -std=c++23 -O2 \
		-fmodule-file=pbsd.lib.msun.src.b0236=pbsd.lib.msun.src.b0236.pcm \
