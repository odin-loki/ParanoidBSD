// PBSD -- mechanical C++23 port of bectl_list.c, proven equivalent to
...
export module pbsd.sbin.bectl.bectl_list;

export namespace pbsd::sbin::bectl::bectl_list {
...
}  // namespace pbsd::sbin::bectl::bectl_list
