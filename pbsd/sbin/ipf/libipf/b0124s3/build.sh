#!/bin/sh
#
# build.sh -- build and run the PBSD b0124s3 differential test.
#
# Usage: sh build.sh            (from pbsd/sbin/ipf/libipf/b0124s3/)
...
BUILD=build
MODNAME=pbsd.sbin.ipf.libipf.b0124s3
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -Wl,--wrap=free -o "$BUILD/b0124s3_test"

exec "$BUILD/b0124s3_test"
