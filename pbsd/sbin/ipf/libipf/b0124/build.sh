#!/bin/sh
#
# build.sh -- build and run the PBSD b0124 differential test.
#
# Usage: sh build.sh            (from pbsd/sbin/ipf/libipf/b0124/)
...
BUILD=build
MODNAME=pbsd.sbin.ipf.libipf.b0124
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -Wl,--wrap=free -o "$BUILD/b0124_test"

exec "$BUILD/b0124_test"
