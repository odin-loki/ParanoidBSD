#!/bin/sh
#
# build.sh -- build and run the PBSD b0124s4 differential test.
#
# Usage: sh build.sh            (from pbsd/sbin/ipf/libipf/b0124s4/)
...
BUILD=build
MODNAME=pbsd.sbin.ipf.libipf.b0124s4
...
$CXX $CXXFLAGS $MODFLAGS "$BUILD/port.o" "$BUILD/harness.o" \
    "$BUILD/oracle.o" -o "$BUILD/b0124s4_test"

exec "$BUILD/b0124s4_test"
