#!/bin/sh
#
# build.sh -- build and run the PBSD b0294 differential test.
#
# Usage: sh build.sh		(from pbsd/sbin/ipf/libipf/b0294/)
...
BUILD=build
MODNAME=pbsd.sbin.ipf.libipf.b0294
TEST=$BUILD/b0294_test
