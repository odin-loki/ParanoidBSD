#!/bin/sh
#
# build.sh -- build and run the PBSD b0295 differential test.
#
# Usage: sh build.sh		(from pbsd/sbin/ipf/libipf/b0295/)
...
BUILD=build
MODNAME=pbsd.sbin.ipf.libipf.b0295
TEST=$BUILD/b0295_test
