/*
 * oracle.c -- concatenated reference implementations for PBSD batch b0296.
 */
...
void
ref_printportcmp(int pr, frpcmp_t *frp)
{
	static char *pcmp1[] = { "*", "=", "!=", "<", ">", "<=", ">=",
				 "<>", "><", ":" };
...
int
ref_ntomask(int family, int nbits, u_32_t *ap)
{
	u_32_t mask;
...
ipfunc_t
ref_nametokva(char *name, ioctlfunc_t iocfunc)
{
