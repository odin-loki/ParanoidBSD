#!/bin/sh
#
# build.sh -- build and run the PBSD b0296 differential test.
#
# Usage: sh build.sh		(from pbsd/sbin/ipf/libipf/b0296/)
...
BUILD=build
MODNAME=pbsd.sbin.ipf.libipf.b0296
TEST=$BUILD/b0296_test
