// PBSD -- mechanical C++23 port of ipfsyncd.c, proven equivalent to
...
export module pbsd.sbin.ipf.ipfsync.ipfsyncd;

export namespace pbsd::sbin::ipf::ipfsync::ipfsyncd {
...
}  // namespace pbsd::sbin::ipf::ipfsync::ipfsyncd
