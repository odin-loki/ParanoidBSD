...
export module pbsd.fs.fdesc_vfsops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/fdescfs/fdesc_vfsops.c — Fdesc Vfsops scaffold.
export namespace pbsd::fs::fdesc_vfsops {
...
} // namespace pbsd::fs::fdesc_vfsops
