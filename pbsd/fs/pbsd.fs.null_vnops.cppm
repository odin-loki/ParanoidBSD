...
export module pbsd.fs.null_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/nullfs/null_vnops.c — Null Vnops scaffold.
export namespace pbsd::fs::null_vnops {
