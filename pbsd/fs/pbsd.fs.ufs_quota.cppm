...
export module pbsd.fs.ufs_quota;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/ufs/ufs/ufs_quota.c — Ufs Quota scaffold.
export namespace pbsd::fs::ufs_quota {
