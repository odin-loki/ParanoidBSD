...
export module pbsd.fs.smbfs_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/smbfs/smbfs_vnops.c — Smbfs Vnops scaffold.
export namespace pbsd::fs::smbfs_vnops {
