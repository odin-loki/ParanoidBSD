...
export module pbsd.fs.procfs_status;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/procfs/procfs_status.c — Procfs Status scaffold.
export namespace pbsd::fs::procfs_status {
...
} // namespace pbsd::fs::procfs_status
