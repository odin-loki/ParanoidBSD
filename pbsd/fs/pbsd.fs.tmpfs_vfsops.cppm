...
export module pbsd.fs.tmpfs_vfsops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/tmpfs/tmpfs_vfsops.c — Tmpfs Vfsops scaffold.
export namespace pbsd::fs::tmpfs_vfsops {
...
} // namespace pbsd::fs::tmpfs_vfsops
