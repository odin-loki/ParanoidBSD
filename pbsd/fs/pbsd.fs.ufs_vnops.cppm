...
export module pbsd.fs.ufs_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/ufs/ufs/ufs_vnops.c — Ufs Vnops scaffold.
export namespace pbsd::fs::ufs_vnops {
