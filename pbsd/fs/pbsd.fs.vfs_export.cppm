...
export module pbsd.fs.vfs_export;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/vfs_export.c — Vfs Export scaffold.
export namespace pbsd::fs::vfs_export {
