...
export module pbsd.fs.devfs_devs;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/devfs/devfs_devs.c — Devfs Devs scaffold.
export namespace pbsd::fs::devfs_devs {
