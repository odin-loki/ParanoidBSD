...
export module pbsd.fs.vfs_cluster;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/vfs_cluster.c — Vfs Cluster scaffold.
export namespace pbsd::fs::vfs_cluster {
