...
export module pbsd.fs.tmpfs_subr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/tmpfs/tmpfs_subr.c — Tmpfs Subr scaffold.
export namespace pbsd::fs::tmpfs_subr {
