...
export module pbsd.fs.ext2_hash;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_hash.c — Ext2 Hash scaffold.
export namespace pbsd::fs::ext2_hash {
