...
export module pbsd.fs.ext2_balloc;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_balloc.c — Ext2 Balloc scaffold.
export namespace pbsd::fs::ext2_balloc {
