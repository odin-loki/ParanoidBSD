...
export module pbsd.fs.procfs_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/procfs/procfs_vnops.c — Procfs Vnops scaffold.
export namespace pbsd::fs::procfs_vnops {
...
} // namespace pbsd::fs::procfs_vnops
