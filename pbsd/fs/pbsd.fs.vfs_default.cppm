...
export module pbsd.fs.vfs_default;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/vfs_default.c — Vfs Default scaffold.
export namespace pbsd::fs::vfs_default {
