...
export module pbsd.fs.ext2_subr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_subr.c — Ext2 Subr scaffold.
export namespace pbsd::fs::ext2_subr {
