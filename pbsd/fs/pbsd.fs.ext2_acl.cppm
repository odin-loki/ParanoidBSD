...
export module pbsd.fs.ext2_acl;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_acl.c — Ext2 Acl scaffold.
export namespace pbsd::fs::ext2_acl {
