...
export module pbsd.fs.nfs_clvfsops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/nfs/nfs_clvfsops.c — Nfs Clvfsops scaffold.
export namespace pbsd::fs::nfs_clvfsops {
...
} // namespace pbsd::fs::nfs_clvfsops
