...
export module pbsd.fs.udf_vfsops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/udf/udf_vfsops.c — Udf Vfsops scaffold.
export namespace pbsd::fs::udf_vfsops {
