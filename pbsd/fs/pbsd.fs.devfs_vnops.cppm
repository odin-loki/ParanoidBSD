...
export module pbsd.fs.devfs_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/devfs/devfs_vnops.c — Devfs Vnops scaffold.
export namespace pbsd::fs::devfs_vnops {
