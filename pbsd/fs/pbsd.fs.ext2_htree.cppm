...
export module pbsd.fs.ext2_htree;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_htree.c — Ext2 Htree scaffold.
export namespace pbsd::fs::ext2_htree {
