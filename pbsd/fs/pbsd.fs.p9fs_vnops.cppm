...
export module pbsd.fs.p9fs_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/p9fs/p9fs_vnops.c — P9Fs Vnops scaffold.
export namespace pbsd::fs::p9fs_vnops {
