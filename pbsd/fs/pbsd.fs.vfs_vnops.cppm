...
export module pbsd.fs.vfs_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/vfs_vnops.c — Vfs Vnops scaffold.
export namespace pbsd::fs::vfs_vnops {
