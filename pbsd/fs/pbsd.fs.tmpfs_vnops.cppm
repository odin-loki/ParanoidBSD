...
export module pbsd.fs.tmpfs_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/tmpfs/tmpfs_vnops.c — Tmpfs Vnops scaffold.
export namespace pbsd::fs::tmpfs_vnops {
