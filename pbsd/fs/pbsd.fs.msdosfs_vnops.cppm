...
export module pbsd.fs.msdosfs_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/msdosfs/msdosfs_vnops.c — Msdosfs Vnops scaffold.
export namespace pbsd::fs::msdosfs_vnops {
...
} // namespace pbsd::fs::msdosfs_vnops
