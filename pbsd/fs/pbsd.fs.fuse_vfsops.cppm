...
export module pbsd.fs.fuse_vfsops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/fuse/fuse_vfsops.c — Fuse Vfsops scaffold.
export namespace pbsd::fs::fuse_vfsops {
