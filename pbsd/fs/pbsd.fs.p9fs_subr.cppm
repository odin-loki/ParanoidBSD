...
export module pbsd.fs.p9fs_subr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/p9fs/p9fs_subr.c — P9Fs Subr scaffold.
export namespace pbsd::fs::p9fs_subr {
