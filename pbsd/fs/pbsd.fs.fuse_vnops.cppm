...
export module pbsd.fs.fuse_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/fuse/fuse_vnops.c — Fuse Vnops scaffold.
export namespace pbsd::fs::fuse_vnops {
