...
export module pbsd.fs.devfs_rule;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/devfs/devfs_rule.c — Devfs Rule scaffold.
export namespace pbsd::fs::devfs_rule {
