...
export module pbsd.fs.null_vfsops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/nullfs/null_vfsops.c — Null Vfsops scaffold.
export namespace pbsd::fs::null_vfsops {
