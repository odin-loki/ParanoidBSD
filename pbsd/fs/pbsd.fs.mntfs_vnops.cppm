...
export module pbsd.fs.mntfs_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/mntfs/mntfs_vnops.c — Mntfs Vnops scaffold.
export namespace pbsd::fs::mntfs_vnops {
