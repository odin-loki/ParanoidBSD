...
export module pbsd.fs.ext2_lookup;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_lookup.c — Ext2 Lookup scaffold.
export namespace pbsd::fs::ext2_lookup {
