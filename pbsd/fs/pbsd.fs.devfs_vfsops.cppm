...
export module pbsd.fs.devfs_vfsops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/devfs/devfs_vfsops.c — Devfs Vfsops scaffold.
export namespace pbsd::fs::devfs_vfsops {
...
} // namespace pbsd::fs::devfs_vfsops
