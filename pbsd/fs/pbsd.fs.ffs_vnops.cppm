...
export module pbsd.fs.ffs_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/ufs/ffs/ffs_vnops.c — Ffs Vnops scaffold.
export namespace pbsd::fs::ffs_vnops {
