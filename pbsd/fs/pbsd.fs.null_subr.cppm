...
export module pbsd.fs.null_subr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/nullfs/null_subr.c — Null Subr scaffold.
export namespace pbsd::fs::null_subr {
