...
export module pbsd.fs.ext2_extattr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_extattr.c — Ext2 Extattr scaffold.
export namespace pbsd::fs::ext2_extattr {
...
} // namespace pbsd::fs::ext2_extattr
