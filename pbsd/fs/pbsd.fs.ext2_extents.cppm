...
export module pbsd.fs.ext2_extents;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_extents.c — Ext2 Extents scaffold.
export namespace pbsd::fs::ext2_extents {
...
} // namespace pbsd::fs::ext2_extents
