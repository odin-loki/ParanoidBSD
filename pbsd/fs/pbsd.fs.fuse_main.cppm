...
export module pbsd.fs.fuse_main;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/fuse/fuse_main.c — Fuse Main scaffold.
export namespace pbsd::fs::fuse_main {
