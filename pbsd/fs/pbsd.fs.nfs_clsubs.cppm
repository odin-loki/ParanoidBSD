...
export module pbsd.fs.nfs_clsubs;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/nfs/nfs_clsubs.c — Nfs Clsubs scaffold.
export namespace pbsd::fs::nfs_clsubs {
