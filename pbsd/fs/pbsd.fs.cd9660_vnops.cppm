...
export module pbsd.fs.cd9660_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/cd9660/cd9660_vnops.c — Cd9660 Vnops scaffold.
export namespace pbsd::fs::cd9660_vnops {
...
} // namespace pbsd::fs::cd9660_vnops
