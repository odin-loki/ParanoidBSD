...
export module pbsd.fs.ext2_inode;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_inode.c — Ext2 Inode scaffold.
export namespace pbsd::fs::ext2_inode {
