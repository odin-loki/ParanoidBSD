...
export module pbsd.fs.dead_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/deadfs/dead_vnops.c — Dead Vnops scaffold.
export namespace pbsd::fs::dead_vnops {
