...
export module pbsd.fs.ext2_alloc;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_alloc.c — Ext2 Alloc scaffold.
export namespace pbsd::fs::ext2_alloc {
