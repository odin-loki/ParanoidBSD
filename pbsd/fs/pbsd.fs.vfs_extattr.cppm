...
export module pbsd.fs.vfs_extattr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/vfs_extattr.c — Vfs Extattr scaffold.
export namespace pbsd::fs::vfs_extattr {
