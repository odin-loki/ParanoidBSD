...
export module pbsd.fs.cd9660_lookup;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/cd9660/cd9660_lookup.c — Cd9660 Lookup scaffold.
export namespace pbsd::fs::cd9660_lookup {
...
} // namespace pbsd::fs::cd9660_lookup
