...
export module pbsd.fs.ext2_vfsops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_vfsops.c — Ext2 Vfsops scaffold.
export namespace pbsd::fs::ext2_vfsops {
