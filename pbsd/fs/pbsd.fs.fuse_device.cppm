...
export module pbsd.fs.fuse_device;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/fuse/fuse_device.c — Fuse Device scaffold.
export namespace pbsd::fs::fuse_device {
