...
export module pbsd.fs.vfs_inotify;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/vfs_inotify.c — Vfs Inotify scaffold.
export namespace pbsd::fs::vfs_inotify {
