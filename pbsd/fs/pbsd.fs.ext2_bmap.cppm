...
export module pbsd.fs.ext2_bmap;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_bmap.c — Ext2 Bmap scaffold.
export namespace pbsd::fs::ext2_bmap {
