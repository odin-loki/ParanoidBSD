...
export module pbsd.fs.cd9660_vfsops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/cd9660/cd9660_vfsops.c — Cd9660 Vfsops scaffold.
export namespace pbsd::fs::cd9660_vfsops {
...
} // namespace pbsd::fs::cd9660_vfsops
