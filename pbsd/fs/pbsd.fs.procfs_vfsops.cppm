...
export module pbsd.fs.procfs_vfsops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/procfs/procfs_vfsops.c — Procfs Vfsops scaffold.
export namespace pbsd::fs::procfs_vfsops {
...
} // namespace pbsd::fs::procfs_vfsops
