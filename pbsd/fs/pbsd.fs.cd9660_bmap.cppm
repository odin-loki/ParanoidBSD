...
export module pbsd.fs.cd9660_bmap;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/cd9660/cd9660_bmap.c — Cd9660 Bmap scaffold.
export namespace pbsd::fs::cd9660_bmap {
