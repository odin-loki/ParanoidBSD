...
export module pbsd.fs.autofs_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/autofs/autofs_vnops.c — Autofs Vnops scaffold.
export namespace pbsd::fs::autofs_vnops {
...
} // namespace pbsd::fs::autofs_vnops
