...
export module pbsd.fs.udf_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/udf/udf_vnops.c — Udf Vnops scaffold.
export namespace pbsd::fs::udf_vnops {
