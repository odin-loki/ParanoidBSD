...
export module pbsd.fs.vfs_lookup;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/vfs_lookup.c — Vfs Lookup scaffold.
export namespace pbsd::fs::vfs_lookup {
