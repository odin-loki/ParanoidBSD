...
export module pbsd.fs.smbfs_subr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/smbfs/smbfs_subr.c — Smbfs Subr scaffold.
export namespace pbsd::fs::smbfs_subr {
