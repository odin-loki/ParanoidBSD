...
export module pbsd.fs.msdosfs_fat;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/msdosfs/msdosfs_fat.c — Msdosfs Fat scaffold.
export namespace pbsd::fs::msdosfs_fat {
