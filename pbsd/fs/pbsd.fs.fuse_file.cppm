...
export module pbsd.fs.fuse_file;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/fuse/fuse_file.c — Fuse File scaffold.
export namespace pbsd::fs::fuse_file {
