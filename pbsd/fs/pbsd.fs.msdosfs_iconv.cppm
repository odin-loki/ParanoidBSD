...
export module pbsd.fs.msdosfs_iconv;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/msdosfs/msdosfs_iconv.c — Msdosfs Iconv scaffold.
export namespace pbsd::fs::msdosfs_iconv {
...
} // namespace pbsd::fs::msdosfs_iconv
