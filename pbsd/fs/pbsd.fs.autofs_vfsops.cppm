...
export module pbsd.fs.autofs_vfsops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/autofs/autofs_vfsops.c — Autofs Vfsops scaffold.
export namespace pbsd::fs::autofs_vfsops {
...
} // namespace pbsd::fs::autofs_vfsops
