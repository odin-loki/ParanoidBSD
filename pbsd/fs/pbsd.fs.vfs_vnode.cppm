...
export module pbsd.fs.vfs_vnode;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/vfs_vnode.c — Vfs Vnode scaffold.
export namespace pbsd::fs::vfs_vnode {
