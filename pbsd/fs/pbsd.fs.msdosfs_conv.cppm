...
export module pbsd.fs.msdosfs_conv;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/msdosfs/msdosfs_conv.c — Msdosfs Conv scaffold.
export namespace pbsd::fs::msdosfs_conv {
...
} // namespace pbsd::fs::msdosfs_conv
