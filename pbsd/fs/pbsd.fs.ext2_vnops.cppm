...
export module pbsd.fs.ext2_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_vnops.c — Ext2 Vnops scaffold.
export namespace pbsd::fs::ext2_vnops {
