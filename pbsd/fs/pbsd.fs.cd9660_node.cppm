...
export module pbsd.fs.cd9660_node;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/cd9660/cd9660_node.c — Cd9660 Node scaffold.
export namespace pbsd::fs::cd9660_node {
