...
export module pbsd.fs.ext2_csum;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/ext2fs/ext2_csum.c — Ext2 Csum scaffold.
export namespace pbsd::fs::ext2_csum {
