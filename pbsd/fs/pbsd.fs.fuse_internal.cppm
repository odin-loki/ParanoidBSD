...
export module pbsd.fs.fuse_internal;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/fuse/fuse_internal.c — Fuse Internal scaffold.
export namespace pbsd::fs::fuse_internal {
...
} // namespace pbsd::fs::fuse_internal
