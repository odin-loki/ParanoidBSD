...
export module pbsd.fs.devfs_dir;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/devfs/devfs_dir.c — Devfs Dir scaffold.
export namespace pbsd::fs::devfs_dir {
