...
export module pbsd.fs.nfs_clvnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/nfs/nfs_clvnops.c — Nfs Clvnops scaffold.
export namespace pbsd::fs::nfs_clvnops {
