...
export module pbsd.fs.cd9660_rrip;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/cd9660/cd9660_rrip.c — Cd9660 Rrip scaffold.
export namespace pbsd::fs::cd9660_rrip {
