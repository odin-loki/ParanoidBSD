...
export module pbsd.fs.cd9660_iconv;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/cd9660/cd9660_iconv.c — Cd9660 Iconv scaffold.
export namespace pbsd::fs::cd9660_iconv {
...
} // namespace pbsd::fs::cd9660_iconv
