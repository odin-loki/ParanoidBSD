...
export module pbsd.fs.nfs_clport;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/nfs/nfs_clport.c — Nfs Clport scaffold.
export namespace pbsd::fs::nfs_clport {
