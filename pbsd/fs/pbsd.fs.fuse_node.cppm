...
export module pbsd.fs.fuse_node;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/fuse/fuse_node.c — Fuse Node scaffold.
export namespace pbsd::fs::fuse_node {
