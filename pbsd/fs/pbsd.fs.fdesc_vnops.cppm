...
export module pbsd.fs.fdesc_vnops;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/fs/fdescfs/fdesc_vnops.c — Fdesc Vnops scaffold.
export namespace pbsd::fs::fdesc_vnops {
