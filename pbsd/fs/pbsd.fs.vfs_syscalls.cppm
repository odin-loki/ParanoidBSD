...
export module pbsd.fs.vfs_syscalls;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/vfs_syscalls.c — Vfs Syscalls scaffold.
export namespace pbsd::fs::vfs_syscalls {
...
} // namespace pbsd::fs::vfs_syscalls
