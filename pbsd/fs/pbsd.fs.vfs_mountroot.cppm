...
export module pbsd.fs.vfs_mountroot;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/vfs_mountroot.c — Vfs Mountroot scaffold.
export namespace pbsd::fs::vfs_mountroot {
...
} // namespace pbsd::fs::vfs_mountroot
