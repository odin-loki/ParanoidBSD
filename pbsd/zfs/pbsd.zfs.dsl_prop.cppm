...
export module pbsd.zfs.dsl_prop;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/dsl_prop.c — Dsl Prop scaffold.
export namespace pbsd::zfs::dsl_prop {
