...
export module pbsd.zfs.lz4_zfs;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/lz4_zfs.c — Lz4 Zfs scaffold.
export namespace pbsd::zfs::lz4_zfs {
