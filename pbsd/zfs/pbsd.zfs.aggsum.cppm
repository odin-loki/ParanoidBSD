...
export module pbsd.zfs.aggsum;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/aggsum.c — Aggsum scaffold.
export namespace pbsd::zfs::aggsum {
