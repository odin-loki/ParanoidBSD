...
export module pbsd.zfs.dmu_send;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/dmu_send.c — Dmu Send scaffold.
export namespace pbsd::zfs::dmu_send {
