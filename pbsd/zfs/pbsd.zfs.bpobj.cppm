...
export module pbsd.zfs.bpobj;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/bpobj.c — Bpobj scaffold.
export namespace pbsd::zfs::bpobj {
