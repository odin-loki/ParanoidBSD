...
export module pbsd.zfs.arc_evict;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/arc.c — Arc Evict scaffold.
export namespace pbsd::zfs::arc_evict {
