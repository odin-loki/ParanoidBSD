...
export module pbsd.zfs.zap_leaf;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/zap_leaf.c — Zap Leaf scaffold.
export namespace pbsd::zfs::zap_leaf {
