...
export module pbsd.zfs.objlist;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/objlist.c — Objlist scaffold.
export namespace pbsd::zfs::objlist {
