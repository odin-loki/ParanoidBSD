...
export module pbsd.zfs.refcount;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/refcount.c — Refcount scaffold.
export namespace pbsd::zfs::refcount {
