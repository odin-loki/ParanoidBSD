...
export module pbsd.zfs.zvol;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/zvol.c — Zvol scaffold.
export namespace pbsd::zfs::zvol {
