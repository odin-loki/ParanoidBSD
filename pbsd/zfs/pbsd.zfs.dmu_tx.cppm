...
export module pbsd.zfs.dmu_tx;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/dmu_tx.c — Dmu Tx scaffold.
export namespace pbsd::zfs::dmu_tx {
