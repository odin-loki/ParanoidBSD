...
export module pbsd.zfs.bqueue;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/bqueue.c — Bqueue scaffold.
export namespace pbsd::zfs::bqueue {
