...
export module pbsd.zfs.bptree;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/bptree.c — Bptree scaffold.
export namespace pbsd::zfs::bptree {
