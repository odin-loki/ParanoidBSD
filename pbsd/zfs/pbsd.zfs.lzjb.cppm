...
export module pbsd.zfs.lzjb;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/lzjb.c — Lzjb scaffold.
export namespace pbsd::zfs::lzjb {
