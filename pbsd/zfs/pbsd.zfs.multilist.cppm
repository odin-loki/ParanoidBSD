...
export module pbsd.zfs.multilist;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/multilist.c — Multilist scaffold.
export namespace pbsd::zfs::multilist {
