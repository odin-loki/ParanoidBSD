...
export module pbsd.zfs.ddt_log;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/ddt_log.c — Ddt Log scaffold.
export namespace pbsd::zfs::ddt_log {
