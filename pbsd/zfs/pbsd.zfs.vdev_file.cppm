...
export module pbsd.zfs.vdev_file;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/vdev_file.c — Vdev File scaffold.
export namespace pbsd::zfs::vdev_file {
