...
export module pbsd.zfs.dsl_deleg;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/dsl_deleg.c — Dsl Deleg scaffold.
export namespace pbsd::zfs::dsl_deleg {
