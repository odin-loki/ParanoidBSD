...
export module pbsd.zfs.blkptr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/blkptr.c — Blkptr scaffold.
export namespace pbsd::zfs::blkptr {
