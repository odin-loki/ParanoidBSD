...
export module pbsd.zfs.dsl_crypt;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/dsl_crypt.c — Dsl Crypt scaffold.
export namespace pbsd::zfs::dsl_crypt {
