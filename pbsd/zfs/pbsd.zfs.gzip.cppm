...
export module pbsd.zfs.gzip;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/gzip.c — Gzip scaffold.
export namespace pbsd::zfs::gzip {
