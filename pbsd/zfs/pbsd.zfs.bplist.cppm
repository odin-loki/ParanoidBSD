...
export module pbsd.zfs.bplist;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/bplist.c — Bplist scaffold.
export namespace pbsd::zfs::bplist {
