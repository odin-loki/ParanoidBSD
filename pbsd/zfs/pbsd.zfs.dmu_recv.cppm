...
export module pbsd.zfs.dmu_recv;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/dmu_recv.c — Dmu Recv scaffold.
export namespace pbsd::zfs::dmu_recv {
