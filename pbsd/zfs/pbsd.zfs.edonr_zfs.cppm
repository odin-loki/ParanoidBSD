...
export module pbsd.zfs.edonr_zfs;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/edonr_zfs.c — Edonr Zfs scaffold.
export namespace pbsd::zfs::edonr_zfs {
