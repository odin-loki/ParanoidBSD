...
export module pbsd.zfs.dmu_diff;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/dmu_diff.c — Dmu Diff scaffold.
export namespace pbsd::zfs::dmu_diff {
