...
export module pbsd.zfs.pathname;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/pathname.c — Pathname scaffold.
export namespace pbsd::zfs::pathname {
