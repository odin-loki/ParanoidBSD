...
export module pbsd.zfs.ddt_stats;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/ddt_stats.c — Ddt Stats scaffold.
export namespace pbsd::zfs::ddt_stats {
