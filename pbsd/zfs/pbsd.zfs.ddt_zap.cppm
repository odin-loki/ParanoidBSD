...
export module pbsd.zfs.ddt_zap;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/ddt_zap.c — Ddt Zap scaffold.
export namespace pbsd::zfs::ddt_zap {
