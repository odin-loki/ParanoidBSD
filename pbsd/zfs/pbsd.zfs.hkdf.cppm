...
export module pbsd.zfs.hkdf;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/hkdf.c — Hkdf scaffold.
export namespace pbsd::zfs::hkdf {
