...
export module pbsd.zfs.btree;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/contrib/openzfs/module/zfs/btree.c — Btree scaffold.
export namespace pbsd::zfs::btree {
