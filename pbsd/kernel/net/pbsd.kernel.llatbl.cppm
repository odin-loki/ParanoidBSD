...
export module pbsd.kernel.llatbl;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/if_llatbl.c — llatbl scaffold.
export namespace pbsd::kernel::llatbl {
