...
export module pbsd.kernel.bpf_filter;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/bpf_filter.c — bpf filter scaffold.
export namespace pbsd::kernel::bpf_filter {
...
} // namespace pbsd::kernel::bpf_filter
