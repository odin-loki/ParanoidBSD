...
export module pbsd.kernel.pfil_helpers;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/pfil.c — pfil helpers scaffold.
export namespace pbsd::kernel::pfil_helpers {
...
} // namespace pbsd::kernel::pfil_helpers
