...
export module pbsd.kernel.ethersubr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/if_ethersubr.c — ethersubr scaffold.
export namespace pbsd::kernel::ethersubr {
...
} // namespace pbsd::kernel::ethersubr
