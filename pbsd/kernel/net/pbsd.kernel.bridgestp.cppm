...
export module pbsd.kernel.bridgestp;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/bridgestp.c — bridgestp scaffold.
export namespace pbsd::kernel::bridgestp {
...
} // namespace pbsd::kernel::bridgestp
