...
export module pbsd.kernel.debugnet;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/net/debugnet.c — debugnet scaffold.
export namespace pbsd::kernel::debugnet {
...
} // namespace pbsd::kernel::debugnet
