...
export module pbsd.kernel.swap_pager;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/swap_pager.c — swap pager scaffold.
export namespace pbsd::kernel::swap_pager {
...
} // namespace pbsd::kernel::swap_pager
