...
export module pbsd.kernel.sg_pager;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/sg_pager.c — sg pager scaffold.
export namespace pbsd::kernel::sg_pager {
...
} // namespace pbsd::kernel::sg_pager
