...
export module pbsd.kernel.vm_unix;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/vm_unix.c — vm unix scaffold.
export namespace pbsd::kernel::vm_unix {
