...
export module pbsd.kernel.vm_pageout;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/vm_pageout.c — vm pageout scaffold.
export namespace pbsd::kernel::vm_pageout {
...
} // namespace pbsd::kernel::vm_pageout
