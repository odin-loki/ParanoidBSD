...
export module pbsd.kernel.memguard;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/memguard.c — memguard scaffold.
export namespace pbsd::kernel::memguard {
...
} // namespace pbsd::kernel::memguard
