...
export module pbsd.kernel.vnode_pager;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/vnode_pager.c — vnode pager scaffold.
export namespace pbsd::kernel::vnode_pager {
...
} // namespace pbsd::kernel::vnode_pager
