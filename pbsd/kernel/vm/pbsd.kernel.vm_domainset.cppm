...
export module pbsd.kernel.vm_domainset;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/vm_domainset.c — vm domainset scaffold.
export namespace pbsd::kernel::vm_domainset {
...
} // namespace pbsd::kernel::vm_domainset
