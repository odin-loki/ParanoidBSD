...
export module pbsd.kernel.vm_mmap;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/vm_mmap.c — vm mmap scaffold.
export namespace pbsd::kernel::vm_mmap {
