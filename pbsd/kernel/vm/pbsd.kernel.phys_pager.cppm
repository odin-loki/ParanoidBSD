...
export module pbsd.kernel.phys_pager;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/phys_pager.c — phys pager scaffold.
export namespace pbsd::kernel::phys_pager {
...
} // namespace pbsd::kernel::phys_pager
