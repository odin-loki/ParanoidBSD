...
export module pbsd.kernel.vm_swapout;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/vm_swapout.c — vm swapout scaffold.
export namespace pbsd::kernel::vm_swapout {
...
} // namespace pbsd::kernel::vm_swapout
