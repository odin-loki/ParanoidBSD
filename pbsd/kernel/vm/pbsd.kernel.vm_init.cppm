...
export module pbsd.kernel.vm_init;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/vm_init.c — vm init scaffold.
export namespace pbsd::kernel::vm_init {
