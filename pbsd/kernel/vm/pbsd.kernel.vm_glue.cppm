...
export module pbsd.kernel.vm_glue;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/vm_glue.c — vm glue scaffold.
export namespace pbsd::kernel::vm_glue {
