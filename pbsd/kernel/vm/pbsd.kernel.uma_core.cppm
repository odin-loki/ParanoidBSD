...
export module pbsd.kernel.uma_core;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/uma_core.c — uma core scaffold.
export namespace pbsd::kernel::uma_core {
...
} // namespace pbsd::kernel::uma_core
