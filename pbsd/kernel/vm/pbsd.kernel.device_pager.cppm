...
export module pbsd.kernel.device_pager;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/vm/device_pager.c — device pager scaffold.
export namespace pbsd::kernel::device_pager {
...
} // namespace pbsd::kernel::device_pager
