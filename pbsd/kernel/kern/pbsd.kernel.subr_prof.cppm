...
export module pbsd.kernel.subr_prof;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_prof.c — Subr Prof scaffold.
export namespace pbsd::kernel::subr_prof {
...
} // namespace pbsd::kernel::subr_prof
