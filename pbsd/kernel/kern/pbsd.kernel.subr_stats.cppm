...
export module pbsd.kernel.subr_stats;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_stats.c — Subr Stats scaffold.
export namespace pbsd::kernel::subr_stats {
...
} // namespace pbsd::kernel::subr_stats
