...
export module pbsd.kernel.kern_sdt;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/kern_sdt.c — kern sdt scaffold.
export namespace pbsd::kernel::kern_sdt {
...
} // namespace pbsd::kernel::kern_sdt
