...
export module pbsd.kernel.kern_dtrace;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/kern_dtrace.c — kern dtrace scaffold.
export namespace pbsd::kernel::kern_dtrace {
...
} // namespace pbsd::kernel::kern_dtrace
