...
export module pbsd.kernel.subr_pcpu;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_pcpu.c — Subr Pcpu scaffold.
export namespace pbsd::kernel::subr_pcpu {
...
} // namespace pbsd::kernel::subr_pcpu
