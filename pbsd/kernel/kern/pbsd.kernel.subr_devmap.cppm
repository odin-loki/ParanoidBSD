...
export module pbsd.kernel.subr_devmap;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_devmap.c — Subr Devmap scaffold.
export namespace pbsd::kernel::subr_devmap {
...
} // namespace pbsd::kernel::subr_devmap
