...
export module pbsd.kernel.subr_power;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_power.c — Subr Power scaffold.
export namespace pbsd::kernel::subr_power {
...
} // namespace pbsd::kernel::subr_power
