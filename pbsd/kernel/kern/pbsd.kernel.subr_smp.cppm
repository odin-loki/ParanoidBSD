...
export module pbsd.kernel.subr_smp;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_smp.c — Subr Smp scaffold.
export namespace pbsd::kernel::subr_smp {
...
} // namespace pbsd::kernel::subr_smp
