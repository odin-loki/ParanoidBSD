...
export module pbsd.kernel.subr_intr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_intr.c — Subr Intr scaffold.
export namespace pbsd::kernel::subr_intr {
...
} // namespace pbsd::kernel::subr_intr
