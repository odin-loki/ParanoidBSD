...
export module pbsd.kernel.subr_kdb;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_kdb.c — Subr Kdb scaffold.
export namespace pbsd::kernel::subr_kdb {
...
} // namespace pbsd::kernel::subr_kdb
