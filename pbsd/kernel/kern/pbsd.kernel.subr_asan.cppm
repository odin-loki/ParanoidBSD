...
export module pbsd.kernel.subr_asan;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_asan.c — subr asan scaffold.
export namespace pbsd::kernel::subr_asan {
...
} // namespace pbsd::kernel::subr_asan
