...
export module pbsd.kernel.subr_log;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_log.c — Subr Log scaffold.
export namespace pbsd::kernel::subr_log {
...
} // namespace pbsd::kernel::subr_log
