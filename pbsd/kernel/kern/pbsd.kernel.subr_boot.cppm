...
export module pbsd.kernel.subr_boot;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_boot.c — Subr Boot scaffold.
export namespace pbsd::kernel::subr_boot {
...
} // namespace pbsd::kernel::subr_boot
