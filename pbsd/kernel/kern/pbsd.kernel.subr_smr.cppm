...
export module pbsd.kernel.subr_smr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_smr.c — Subr Smr scaffold.
export namespace pbsd::kernel::subr_smr {
...
} // namespace pbsd::kernel::subr_smr
