...
export module pbsd.kernel.subr_clock;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_clock.c — Subr Clock scaffold.
export namespace pbsd::kernel::subr_clock {
...
} // namespace pbsd::kernel::subr_clock
