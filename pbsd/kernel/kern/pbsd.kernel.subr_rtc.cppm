...
export module pbsd.kernel.subr_rtc;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_rtc.c — Subr Rtc scaffold.
export namespace pbsd::kernel::subr_rtc {
...
} // namespace pbsd::kernel::subr_rtc
