...
export module pbsd.kernel.subr_disk;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_disk.c — Subr Disk scaffold.
export namespace pbsd::kernel::subr_disk {
...
} // namespace pbsd::kernel::subr_disk
