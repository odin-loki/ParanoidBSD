...
export module pbsd.kernel.subr_csan;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_csan.c — subr csan scaffold.
export namespace pbsd::kernel::subr_csan {
...
} // namespace pbsd::kernel::subr_csan
