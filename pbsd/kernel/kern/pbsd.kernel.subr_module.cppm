...
export module pbsd.kernel.subr_module;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_module.c — Subr Module scaffold.
export namespace pbsd::kernel::subr_module {
...
} // namespace pbsd::kernel::subr_module
