...
export module pbsd.kernel.kern_et;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/kern_et.c — kern et scaffold.
export namespace pbsd::kernel::kern_et {
