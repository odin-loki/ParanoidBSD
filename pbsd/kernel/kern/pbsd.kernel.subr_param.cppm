...
export module pbsd.kernel.subr_param;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_param.c — Subr Param scaffold.
export namespace pbsd::kernel::subr_param {
...
} // namespace pbsd::kernel::subr_param
