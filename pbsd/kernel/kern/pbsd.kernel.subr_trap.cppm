...
export module pbsd.kernel.subr_trap;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_trap.c — Subr Trap scaffold.
export namespace pbsd::kernel::subr_trap {
...
} // namespace pbsd::kernel::subr_trap
