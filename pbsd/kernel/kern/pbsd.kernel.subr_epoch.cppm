...
export module pbsd.kernel.subr_epoch;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_epoch.c — Subr Epoch scaffold.
export namespace pbsd::kernel::subr_epoch {
...
} // namespace pbsd::kernel::subr_epoch
