...
export module pbsd.kernel.subr_early;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_early.c — Subr Early scaffold.
export namespace pbsd::kernel::subr_early {
...
} // namespace pbsd::kernel::subr_early
