...
export module pbsd.kernel.subr_msan;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/kern/subr_msan.c — subr msan scaffold.
export namespace pbsd::kernel::subr_msan {
...
} // namespace pbsd::kernel::subr_msan
