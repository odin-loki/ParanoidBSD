// PBSD -- mechanical C++23 port of hesinfo.c, proven equivalent to
...
export module pbsd.usr_bin.hesinfo.hesinfo;

export namespace pbsd::usr_bin::hesinfo::hesinfo {
...
}  // namespace pbsd::usr_bin::hesinfo::hesinfo
