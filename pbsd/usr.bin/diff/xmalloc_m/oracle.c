...
void *
ref_xcalloc(size_t nmemb, size_t size)
{
	void *ptr;
...
void *
ref_xreallocarray(void *ptr, size_t nmemb, size_t size)
{
	void *new_ptr;
...
int
ref_xasprintf(char **ret, const char *fmt, ...)
{
	va_list ap;
	int i;
