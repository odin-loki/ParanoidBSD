// PBSD -- mechanical C++23 port of xmalloc.c, proven equivalent to
...
export module pbsd.usr_bin.diff.xmalloc;

export namespace pbsd::usr_bin::diff::xmalloc {
...
}  // namespace pbsd::usr_bin::diff::xmalloc
