...
export module pbsd.geom.eli_crypto;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/eli/g_eli_crypto.c — Eli Crypto scaffold.
export namespace pbsd::geom::eli_crypto {
...
} // namespace pbsd::geom::eli_crypto
