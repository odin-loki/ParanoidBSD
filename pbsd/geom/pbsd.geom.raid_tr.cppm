...
export module pbsd.geom.raid_tr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/raid/g_raid_tr.c — Raid Tr scaffold.
export namespace pbsd::geom::raid_tr {
