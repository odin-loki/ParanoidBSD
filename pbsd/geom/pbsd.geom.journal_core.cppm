...
export module pbsd.geom.journal_core;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/journal/g_journal.c — Journal Core scaffold.
export namespace pbsd::geom::journal_core {
...
} // namespace pbsd::geom::journal_core
