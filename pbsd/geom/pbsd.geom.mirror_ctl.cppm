...
export module pbsd.geom.mirror_ctl;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/mirror/g_mirror_ctl.c — Mirror Ctl scaffold.
export namespace pbsd::geom::mirror_ctl {
...
} // namespace pbsd::geom::mirror_ctl
