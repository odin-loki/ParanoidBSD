...
export module pbsd.geom.raid_md_ddf;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/raid/md_ddf.c — Raid Md Ddf scaffold.
export namespace pbsd::geom::raid_md_ddf {
...
} // namespace pbsd::geom::raid_md_ddf
