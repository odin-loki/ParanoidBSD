...
export module pbsd.geom.label_gpt;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/label/g_label_gpt.c — Label Gpt scaffold.
export namespace pbsd::geom::label_gpt {
