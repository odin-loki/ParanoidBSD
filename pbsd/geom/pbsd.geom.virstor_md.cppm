...
export module pbsd.geom.virstor_md;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/virstor/g_virstor_md.c — Virstor Md scaffold.
export namespace pbsd::geom::virstor_md {
...
} // namespace pbsd::geom::virstor_md
