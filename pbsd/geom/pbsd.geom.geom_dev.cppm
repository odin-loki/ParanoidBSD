...
export module pbsd.geom.geom_dev;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/geom_dev.c — Geom Dev scaffold.
export namespace pbsd::geom::geom_dev {
