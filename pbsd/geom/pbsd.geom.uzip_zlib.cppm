...
export module pbsd.geom.uzip_zlib;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/uzip/g_uzip_zlib.c — Uzip Zlib scaffold.
export namespace pbsd::geom::uzip_zlib {
