...
export module pbsd.geom.raid_tr_raid5;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/raid/tr_raid5.c — Raid Tr Raid5 scaffold.
export namespace pbsd::geom::raid_tr_raid5 {
...
} // namespace pbsd::geom::raid_tr_raid5
