...
export module pbsd.geom.part_apm;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/part/g_part_apm.c — Part Apm scaffold.
export namespace pbsd::geom::part_apm {
