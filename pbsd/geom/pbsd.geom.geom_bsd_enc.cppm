...
export module pbsd.geom.geom_bsd_enc;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/geom_bsd_enc.c — Geom Bsd Enc scaffold.
export namespace pbsd::geom::geom_bsd_enc {
...
} // namespace pbsd::geom::geom_bsd_enc
