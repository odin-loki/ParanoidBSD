...
export module pbsd.geom.geom_kern;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/geom_kern.c — Geom Kern scaffold.
export namespace pbsd::geom::geom_kern {
