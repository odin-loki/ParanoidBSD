...
export module pbsd.geom.eli_ctl;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/eli/g_eli_ctl.c — Eli Ctl scaffold.
export namespace pbsd::geom::eli_ctl {
