...
export module pbsd.geom.label_swap;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/label/g_label_swap.c — Label Swap scaffold.
export namespace pbsd::geom::label_swap {
...
} // namespace pbsd::geom::label_swap
