...
export module pbsd.geom.raid_md_intel;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/raid/md_intel.c — Raid Md Intel scaffold.
export namespace pbsd::geom::raid_md_intel {
...
} // namespace pbsd::geom::raid_md_intel
