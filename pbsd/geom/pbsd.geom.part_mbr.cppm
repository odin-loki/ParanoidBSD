...
export module pbsd.geom.part_mbr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/part/g_part_mbr.c — Part Mbr scaffold.
export namespace pbsd::geom::part_mbr {
