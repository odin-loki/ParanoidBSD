...
export module pbsd.geom.eli_privacy;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/eli/g_eli_privacy.c — Eli Privacy scaffold.
export namespace pbsd::geom::eli_privacy {
...
} // namespace pbsd::geom::eli_privacy
