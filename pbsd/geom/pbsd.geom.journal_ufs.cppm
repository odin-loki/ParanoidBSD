...
export module pbsd.geom.journal_ufs;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/journal/g_journal_ufs.c — Journal Ufs scaffold.
export namespace pbsd::geom::journal_ufs {
...
} // namespace pbsd::geom::journal_ufs
