...
export module pbsd.geom.raid_md_sii;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/raid/md_sii.c — Raid Md Sii scaffold.
export namespace pbsd::geom::raid_md_sii {
...
} // namespace pbsd::geom::raid_md_sii
