...
export module pbsd.geom.part_gpt;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/part/g_part_gpt.c — Part Gpt scaffold.
export namespace pbsd::geom::part_gpt {
