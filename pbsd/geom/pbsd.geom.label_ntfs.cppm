...
export module pbsd.geom.label_ntfs;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/label/g_label_ntfs.c — Label Ntfs scaffold.
export namespace pbsd::geom::label_ntfs {
...
} // namespace pbsd::geom::label_ntfs
