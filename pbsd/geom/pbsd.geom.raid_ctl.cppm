...
export module pbsd.geom.raid_ctl;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/raid/g_raid_ctl.c — Raid Ctl scaffold.
export namespace pbsd::geom::raid_ctl {
