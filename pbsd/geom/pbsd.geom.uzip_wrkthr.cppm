...
export module pbsd.geom.uzip_wrkthr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/uzip/g_uzip_wrkthr.c — Uzip Wrkthr scaffold.
export namespace pbsd::geom::uzip_wrkthr {
...
} // namespace pbsd::geom::uzip_wrkthr
