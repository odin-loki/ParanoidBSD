...
export module pbsd.geom.part_ldm;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/part/g_part_ldm.c — Part Ldm scaffold.
export namespace pbsd::geom::part_ldm {
