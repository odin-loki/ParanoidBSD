...
export module pbsd.geom.eli_key;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/eli/g_eli_key.c — Eli Key scaffold.
export namespace pbsd::geom::eli_key {
