...
export module pbsd.geom.raid_tr_raid0;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/raid/tr_raid0.c — Raid Tr Raid0 scaffold.
export namespace pbsd::geom::raid_tr_raid0 {
...
} // namespace pbsd::geom::raid_tr_raid0
