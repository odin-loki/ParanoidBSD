...
export module pbsd.geom.uzip_lzma;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/uzip/g_uzip_lzma.c — Uzip Lzma scaffold.
export namespace pbsd::geom::uzip_lzma {
