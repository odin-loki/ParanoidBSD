...
export module pbsd.geom.eli_hmac;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/eli/g_eli_hmac.c — Eli Hmac scaffold.
export namespace pbsd::geom::eli_hmac {
