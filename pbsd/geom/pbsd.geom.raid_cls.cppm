...
export module pbsd.geom.raid_cls;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/raid/g_raid_class.c — Raid Cls scaffold.
export namespace pbsd::geom::raid_cls {
