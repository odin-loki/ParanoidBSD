...
export module pbsd.geom.label_vtoc8;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/label/g_label_vtoc8.c — Label Vtoc8 scaffold.
export namespace pbsd::geom::label_vtoc8 {
...
} // namespace pbsd::geom::label_vtoc8
