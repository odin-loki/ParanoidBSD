...
export module pbsd.geom.part_ebr;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/part/g_part_ebr.c — Part Ebr scaffold.
export namespace pbsd::geom::part_ebr {
