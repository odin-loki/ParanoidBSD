...
export module pbsd.geom.raid3_ctl;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/raid3/g_raid3_ctl.c — Raid3 Ctl scaffold.
export namespace pbsd::geom::raid3_ctl {
