...
export module pbsd.geom.part_bsd;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/part/g_part_bsd.c — Part Bsd scaffold.
export namespace pbsd::geom::part_bsd {
