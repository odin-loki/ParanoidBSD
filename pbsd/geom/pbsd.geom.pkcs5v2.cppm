...
export module pbsd.geom.pkcs5v2;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/eli/pkcs5v2.c — Pkcs5V2 scaffold.
export namespace pbsd::geom::pkcs5v2 {
