...
export module pbsd.geom.label_ufs;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/label/g_label_ufs.c — Label Ufs scaffold.
export namespace pbsd::geom::label_ufs {
