...
export module pbsd.geom.raid_tr_raid1;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/raid/tr_raid1.c — Raid Tr Raid1 scaffold.
export namespace pbsd::geom::raid_tr_raid1 {
...
} // namespace pbsd::geom::raid_tr_raid1
