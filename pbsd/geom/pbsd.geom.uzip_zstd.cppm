...
export module pbsd.geom.uzip_zstd;

import pbsd.core;

/// PROVENANCE: hbsd/src/sys/geom/uzip/g_uzip_zstd.c — Uzip Zstd scaffold.
export namespace pbsd::geom::uzip_zstd {
