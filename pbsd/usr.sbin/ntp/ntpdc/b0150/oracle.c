/*
 * oracle.c -- reference implementation for PBSD batch b0150.
 *
 * Original HardenedBSD source: hbsd/src/usr.sbin/ntp/ntpdc/nl.c
 * (included in ntpdc-layout.c main).  Function bodies are UNMODIFIED.
 */
