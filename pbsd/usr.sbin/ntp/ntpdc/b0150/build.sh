#!/bin/sh
#
# Build and run the b0150 differential test.  Run as `sh build.sh' from
# pbsd/usr.sbin/ntp/ntpdc/b0150/.  The exit status is the harness's exit status.
...
MODNAME=pbsd.usr.sbin.ntp.ntpdc.b0150
