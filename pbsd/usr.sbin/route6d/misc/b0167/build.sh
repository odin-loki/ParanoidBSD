#!/bin/sh
#
# Build and run the b0167 differential test.  Run as `sh build.sh' from
# pbsd/usr.sbin/route6d/misc/b0167/.  The exit status is the harness's exit status.
...
MODNAME=pbsd.usr.sbin.route6d.misc.b0167
