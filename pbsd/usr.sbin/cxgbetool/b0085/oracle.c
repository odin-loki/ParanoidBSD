...
struct reg_info ref_t4vf_sge_regs[] = {
...
struct reg_info ref_t5vf_sge_regs[] = {
...
struct reg_info ref_t4vf_mps_regs[] = {
	{ "MPS_VF_CTL",	0x100, 0 },
		{ "TxEn", 1, 1 },
		{ "RxEn", 0, 1 },
...
struct reg_info ref_t4vf_pl_regs[] = {
...
struct reg_info ref_t5vf_pl_regs[] = {
	{ "PL_WHOAMI",				0x200, 0 },
		{ "PortxMap", 24, 3 },
		{ "SourceBus", 16, 2 },
		{ "SourcePF", 8, 3 },
...
struct reg_info ref_t6vf_pl_regs[] = {
	{ "PL_WHOAMI",				0x200, 0 },
		{ "PortxMap", 24, 3 },
		{ "SourceBus", 16, 2 },
		{ "SourcePF", 9, 3 },
...
struct reg_info ref_t4vf_cim_regs[] = {
	/*
...
struct reg_info ref_t4vf_mbdata_regs[] = {
