...
export module pbsd.uda.em_82574;
...
/// PROVENANCE: hbsd/src/sys/dev/e1000/{e1000_regs.h,e1000_hw.h,if_em.c}
export namespace pbsd::uda::em_82574 {
...
inline constexpr std::uint16_t kPciDev82574L     = 0x10D3;

inline constexpr RegInsn kEm82574Init[] = {
...
inline constexpr RegInsn kEm82574Reset[] = {
    {RegOp::Write32, kRegCtrl, kCtrlRst, 0, 0},
    {RegOp::Done, 0, 0, 0, 0},
};

[[nodiscard]] inline constexpr Descriptor em_82574l() noexcept {
    return Descriptor{
        .name = "em-82574l",
        .provenance = "hbsd/src/sys/dev/e1000/e1000_hw.h",
        .device_class = DeviceClass::Network,
        .vendor_id = kPciVendorIntel,
        .device_id = kPciDev82574L,
        .init_sequence = kEm82574Init,
        .reset_sequence = kEm82574Reset,
    };
}

[[nodiscard]] inline constexpr bool matches_pci(std::uint16_t vendor,
                                                std::uint16_t device) noexcept {
    return vendor == kPciVendorIntel && device == kPciDev82574L;
}
